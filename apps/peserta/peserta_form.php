	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <?php if(empty($pro)){ ?>onchange="do_search('index.php?data=<? print base64_encode('user;peserta/peserta_form.php;peserta;peserta');?>')" <?php } ?>/> cth: 700104102478</td>
            ...
            <tr>
                ...
                <td align="left" colspan="2"><input type="text" name="f_peserta_tel_pejabat" size="20" maxlength="15" value="<? print $rs->fields['f_peserta_tel_pejabat'];?>"></td>
            </tr>
            <tr>
                <td align="left"><b>No. Telefon Rumah : </b></td>
                <td align="left" colspan="2"><input type="text" name="f_peserta_tel_rumah" size="20" maxlength="15" value="<? print $rs->fields['f_peserta_tel_rumah'];?>"></td>
            </tr>
            <tr>
                <td align="left"><b>No. Telefon Bimbit : </b></td>
                <td align="left" colspan="2"><input type="text" name="f_peserta_hp" size="20" maxlength="15" value="<? print $rs->fields['f_peserta_hp'];?>"></td>
            </tr>
            <tr>
                <td align="left"><b>No. Faks : </b></td>
                <td colspan="2" align="left"><input type="text" name="f_peserta_faks" size="20" maxlength="15" value="<? print $rs->fields['f_peserta_faks'];?>"></td>
            </tr>
            <tr>
                <td align="left"><b>Email : </b></td>
                <td colspan="2"><input type="text" name="f_peserta_email" size="80" value="<? print $rs->fields['f_peserta_email'];?>" /></td>
          </tr>
            <tr>
                <td valign="top" align="left"><b>Alamat Tempat Bertugas : </b></td>
                <td colspan="2"><input type="text" name="f_peserta_alamat1" size="80" value="<? print $rs->fields['f_peserta_alamat1'];?>" /></td>
            </tr>
            <tr>
                <td valign="top" align="left">&nbsp;</td>
                <td colspan="2"><input type="text" name="f_peserta_alamat2" size="80" value="<? print $rs->fields['f_peserta_alamat2'];?>" /></td>
            </tr>
            <tr>
                <td valign="top">&nbsp;</td>
                <td colspan="2"><input type="text" name="f_peserta_alamat3" size="80" value="<? print $rs->fields['f_peserta_alamat3'];?>" /></td>
            </tr>
            <tr>
          ...
          <tr>
			...
			<tr>
                ...
                <td colspan="2"><input type="text" name="f_waris_nama" size="80" value="<? print $rs->fields['f_waris_nama'];?>"></td>
            </tr>
            <tr>
                <td valign="top" align="left"><b>Alamat Waris : </b></td>
                <td colspan="2"><input type="text" name="f_waris_alamat1" size="80" value="<? print $rs->fields['f_waris_alamat1'];?>" /></td>
            </tr>
            <tr>
                <td valign="top" align="left">&nbsp;</td>
                <td colspan="2"><input type="text" name="f_waris_alamat2" size="80" value="<? print $rs->fields['f_waris_alamat2'];?>" /></td>
            </tr>
            <tr>
                <td valign="top">&nbsp;</td>
                <td colspan="2"><input type="text" name="f_waris_alamat3" size="80" value="<? print $rs->fields['f_waris_alamat3'];?>" /></td>
            </tr>
            <tr>
                <td align="left"><b>No. Telefon : </b></td>
                <td align="left" colspan="2"><input type="text" name="f_waris_tel" size="20" maxlength="15" value="<? print $rs->fields['f_waris_tel'];?>"></td>
            </tr>
            ...
            <tr>
                <td colspan="4" align="center"><br>
                    ...
                    onClick="form_hantar('index.php?data=<? print base64_encode('user;peserta/peserta_form_do.php;peserta;peserta')?>')">
                	<? if(!empty($id)){ ?>
                    <input type="button" value="Hapus" class="button_disp" title="Sila klik untuk hapus maklumat peserta" 
                    onClick="form_hapus('index.php?data=<? print base64_encode('user;peserta/peserta_form_do.php;peserta;peserta')?>')">
                    <? } ?>
                	<input type="button" value="Kembali" class="button_disp" title="Sila klik untuk ke senarai peserta" 
                    onClick="do_back('index.php?data=<? print base64_encode('user;peserta/peserta_list.php;peserta;peserta');?>')">
