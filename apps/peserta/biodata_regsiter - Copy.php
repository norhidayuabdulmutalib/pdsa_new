	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="1" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <input type="text" name="f_peserta_noic"  value="<? print $_SESSION["s_logid"];?>" readonly="readonly" style="background-color:#CCCCCC" /></td>
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" size="65" name="f_peserta_nama" value="<? print $rs->fields['f_peserta_nama'];?>"
          ...
          <tr>
            ...
            <tr>
                <td colspan="4" align="center"><br>
                    ...
                    onClick="form_hantar('index.php?data=<? print base64_encode('user;peserta/biodata.php;peserta;biodata')?>')">
                	<? //if(!empty($id)){ ?>
                    <!--<input type="button" value="Hapus" class="button_disp" title="Sila klik untuk hapus maklumat penceramah" 
                    onClick="form_hapus('index.php?data=<? print base64_encode('user;peserta/biodata.php;peserta;biodata')?>')">-->
                    <? //} ?>
