...
extract($_POST);
	...
	$sqli ="INSERT INTO _tbl_kursus_jadual_peserta (peserta_icno, EventId, InternalStudentSelectedDt, InternalStudentInputDt, InternalStudentInputBy)
	VALUES (".tosql($f_peserta_noic).", ".tosql($idk).", ".tosql(date("Y-m-d H:i:s")).", ".tosql(date("Y-m-d H:i:s")).", ".tosql($f_peserta_noic).")";
	...
	//$conn->debug=true;
	$idp = uniqid(date("Ymd"));
	$sql = "INSERT INTO _tbl_peserta(f_peserta_noic, f_peserta_nama, f_title_grade, f_peserta_jantina, BranchCd,
	...
	f_peserta_lahir)
	VALUES(".tosql($f_peserta_noic).", ".tosql($f_peserta_nama).", ".tosql($f_title_grade).", ".tosql($f_peserta_jantina).", ".tosql($BranchCd).", 
...
$sSQL="SELECT * FROM _tbl_peserta  WHERE is_deleted=0 AND f_peserta_noic = ".tosql($nokp,"Text");
	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="1" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <input type="text" name="f_peserta_noic"  value="<? print $nokp;?>" readonly="readonly" style="background-color:#CCCCCC" /></td>
