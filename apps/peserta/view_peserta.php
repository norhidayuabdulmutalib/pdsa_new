    	...
    	<table width="100%" cellpadding="1" cellspacing="0" border="0" align="center">
          ...
          <tr>
            ...
            <tr>
                ...
                <td width="50%" colspan="1"><? print $rs->fields['f_peserta_tel_rumah'];?></td>
            </tr>
            <tr>
                <td width="20%"><strong>No. Telefon Bimbit : </strong></td>
                <td width="50%" colspan="1"><? print $rs->fields['f_peserta_hp'];?></td>
            </tr>
            <tr>
                <td width="20%"><strong>Emel : </strong></td>
                <td width="50%" colspan="1"><? print $rs->fields['f_peserta_email'];?></td>
            </tr>
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><? print $rs->fields['f_peserta_tel_pejabat'];?></td>
            </tr>
            <tr>
                <td width="20%"><strong>No. Faks : </strong></td>
                <td width="50%" colspan="2"><? print $rs->fields['f_peserta_faks'];?></td>
            </tr>
            <tr><td colspan="4"><hr /></td></tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><? print $rs->fields['f_peserta_alamat1'];?></td>
            </tr>
            <tr>
                <td valign="top">&nbsp;</td>
                <td colspan="2"><? print $rs->fields['f_peserta_alamat2'];?></td>
            </tr>
            <tr>
                <td valign="top">&nbsp;</td>
                <td colspan="2"><? print $rs->fields['f_peserta_alamat3'];?></td>
            </tr>
            <tr>
                <td valign="top"><strong>Poskod : </strong>&nbsp;</td>
                <td colspan="2"><? print $rs->fields['f_peserta_poskod'];?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><? print $rspenyelia->fields['nama_ketuajabatan'];?></td>
            </tr>
            <tr>
                <td><strong>Jawatan <font color="#FF0000">*</font> : </strong></td>
                <td colspan="2"><? print $rspenyelia->fields['jawatan_ketuajabatan'];?></td>
            </tr>
            <tr>
                <td><strong>Emel <font color="#FF0000">*</font> : </strong></td>
                <td colspan="2"><? print $rspenyelia->fields['email_ketuajabatan'];?></td>
            </tr>
			<?php //} ?>
            <?php //} ?>
        </table>
