...
$href_search = "index.php?data=".base64_encode('user;peserta/peserta_list_kluar.php;peserta;kluar');
?>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                ...
                if(!$rs->EOF) {
                    ...
                    //while(!$rs->EOF) {
						...
						$href_link = "index.php?data=".base64_encode('user;peserta/peserta_form_kluar.php;peserta;kluar;'.$rs->fields['id_peserta']);
