    	...
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
          ...
          <tr>
			...
			<tr>
                ...
                <td colspan="2">RM <input type="text" name="payperhours" value="<? print number_format($rs->fields['payperhours'],2);?>" /> 
            ...
            <tr>
                ...
                <td align="center"><br>
                    ...
                    <? } ?>
					<? $cetak = "modal_form.php?win=".base64_encode('penceramah/cetak_biodata_penceramah.php;'.$id);?>
