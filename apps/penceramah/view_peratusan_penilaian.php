  ...
  <TBODY style="width:100%">
	...
	<tr><td colspan="5"><table width="100%" border="1" cellpadding="5" cellspacing="0">
        ...
        <tr>
			...
			WHERE A.peserta_icno=B.f_peserta_noic AND A.InternalStudentAccepted=1 AND B.BranchCd='0099' AND B.is_deleted=0 AND A.EventId=".tosql($id);
			//print $sqlj;
      ...
      <tr>
		...
		<table width="100%" border="1" cellpadding="5" cellspacing="0">
            ...
            $sqljlain = "SELECT count(*) as grades, B.f_title_grade FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B
                        WHERE A.peserta_icno=B.f_peserta_noic AND A.InternalStudentAccepted=1 AND B.is_deleted=0 AND A.EventId=".tosql($id)." GROUP BY B.f_title_grade";
        ...
        <td colspan="3" valign="top"><b>Negeri Tempat Bertugas : </b><br />
            <table width="100%" border="1" cellpadding="5" cellspacing="0">
                ...
                $sqljlain = "SELECT count(*) as negeris, B.f_peserta_negeri FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B
                            WHERE A.peserta_icno=B.f_peserta_noic AND A.InternalStudentAccepted=1 AND A.EventId=".tosql($id)." AND B.is_deleted=0 GROUP BY B.f_peserta_negeri";
                $rsjlain = &$conn->Execute($sqljlain); 
				$conn->debug=false;
...
$fset_id = $rs->fields['fset_id'];
	...
	$sql_det .= " AND A.fsetb_pensyarah_id=".tosql($_SESSION["s_userid"]);
	...
	$rs_bhg = &$conn->Execute($sql_det);
            ...
            ?>
                    ...
                    if(!empty($fsetb_pensyarah_id)){ // JIKA MELIBATKAN PENSYARAH
						...
						WHERE A.event_id=".tosql($id)." AND B.ingenid=".tosql($_SESSION["s_userid"])." 
						AND A.id_pensyarah=".tosql($fsetb_pensyarah_id)." AND A.id_pensyarah=B.ingenid AND A.id_jadmasa=".tosql($fsetb_jadmasaid);
...
?>
    ...
    <tr><td colspan="5">
    	<table width="100%" cellpadding="5" cellspacing="0" border="1">
        	<tr bgcolor="#CCCCCC"><td colspan="2"><b>Senarai maklumat tambahan penilaian</b></td></tr>
        	<tr bgcolor="#CCCCCC">
            	<td id="5%"><b>Bil</b></td>
                <td width="95%"><b>Kenyataan</b></td>
            </tr>
