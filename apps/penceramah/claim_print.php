    	...
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
           ...
           <tr>
                ...
                <td colspan="3">
                	<table width="99%" cellpadding="3" cellspacing="0" border="1" align="center">
                        <tr>
                          ...
                          <td width="48%"><? print $rs->fields['cl_depcd'];?></td>
                          <td width="16%">Kod Pejabat Perakaunan</td>
                          <td width="22%"><? print $rs->fields['cl_accoffcd'];?></td>
                  </tr>
                  <tr>
                        <td>PTJ</td>
                        <td><? print $rs->fields['cl_ptjdesc'];?></td>
                        <td>Kod PTJ</td>
                        <td><? print $rs->fields['cl_ptjcd'];?></td>
                  </tr>
                   <tr>
                     <td>Pusat Pembayaran</td>
                     <td><? print $rs->fields['cl_payctrdesc'];?></td>
                     <td>Kod Pusat Pembayaran</td>
                     <td><? print $rs->fields['cl_payctrcd'];?></td>
                   </tr>
                   <tr>
                     <td>Cawangan</td>
                     <td><? print $rs->fields['cl_brchdesc'];?></td>
                     <td>Kod Cawangan</td>
                     <td><? print $rs->fields['cl_brchcd'];?></td>
                   </tr>
                   <tr>
                     <td>Jenis Dok. Asal</td>
                     <td><? print $rs->fields['cl_doctype'];?></td>
                     <td>No. Rujukan Dok. Asal</td>
                     <td><? print $rs->fields['cl_docno'];?></td>
                   </tr>
              </table>              
              </td>
            </tr>
            ...
            <tr>
                ...
                <td width="80%" colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_gaji'];?></td>
            </tr>
            <tr>
                <td width="30%">&nbsp;&nbsp;&nbsp;&nbsp;b) Elaun Memangku (Jika ada) : </td>
              <td width="80%" colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_elaun'];?></td>
            </tr>
            <tr>
                <td width="30%">&nbsp;&nbsp;&nbsp;&nbsp;c. No. Gaji / Pekerja: </td>
                <td width="80%" colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_gajino'];?></td>
            </tr>
            <tr>
                <td>6. Nama Bank : </td>
                <td colspan="3" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_bank'];?></td>
            </tr>
            <tr>
                <td>7. Cawangan Bank : </td>
                <td colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_bankbrch'];?></td>
            </tr>
            <tr>
                <td>8. No. Akaun Bank : </td>
                <td colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_akaun'];?></td>
            </tr>
            <tr>
              <td>9. Nama Kementerian / Jabatan / Agensi : </td>
              <td colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print $rs->fields['cl_orgdesc'];?></td>
            </tr>
            <tr>
              <td valign="top">10. Alamat Kementerian / Jabatan / Agensi : </td>
              <td colspan="2" style="border-bottom:thin;border-bottom-style:dotted;"><? print nl2br($rs->fields['cl_orgadd']);?></td>
            </tr>
		</table>
      </td>
    </tr>
            ...
            <tr>
                ...
                <table width="100%" cellpadding="3" cellspacing="0" border="1">
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            ...
                            <td valign="top" align="right"><? echo number_format($pay,2); ?>&nbsp;</td>
                        </tr>
                        <?
                        $cnt = $cnt + 1;
                        $bil = $bil + 1;
					   ...
					   <tr>
                             ...
                             <td align="right"><? print number_format($sum,2);?>&nbsp;</td>
                        </tr>
				<?
                } else {
                ?>
