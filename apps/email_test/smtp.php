...
//
//$board_config['smtp_host']='mail.eraglobalict.com';
//$board_config['smtp_username']='nizamms@eraglobalict.com';
//$board_config['smtp_password']='nizamms';
//$board_config['smtp_host']='mail.islam.gov.my';
//$board_config['smtp_username']='kursus_ilim@islam.gov.my';
//$board_config['smtp_password']='pass100';
//$board_config['smtp_host']='postmaster.1govuc.gov.my';
//$board_config['smtp_username']='kursus_ilim@islam.gov.my';
//$board_config['smtp_password']='P@ssword.123';

$board_config['smtp_host']='postmaster.1govuc.gov.my';
$board_config['smtp_username']='kursus_ilim.islam@1govuc.gov.my';
$board_config['smtp_password']='P@ssword.123';
