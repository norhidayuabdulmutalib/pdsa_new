	                ...
	                <table width="98%" cellpadding="4" cellspacing="0" border="0">
    					<tr>
                        	<td width="100%">
								...
								$select = "SELECT A.courseid, A.coursename, B.startdate, B.enddate, C.InternalStudentAccepted, C.InternalStudentId  
                                ...
                                ?>
                                        ...
                                        Sila <label onclick="open_modal('<?=$sah_window;?>','Senarai peserta kursus pada hari ini <?=date("d/m/Y");?>',70,70)" style="cursor:pointer">
                                        <u><b>klik disini</b></u></label> untuk pengesahan kehadiran
                                        <?php } ?>
                                        </p>
                                <?
                                        $rs_marque->movenext();
