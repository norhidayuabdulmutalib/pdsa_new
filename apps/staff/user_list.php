...
$href_search = "index.php?data=".base64_encode('user;staff/user_list.php;admin;user');
?>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                ...
                <? if($_SESSION["s_UserID"]=='admin'){ ?>
                    <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                        ...
                        <td align="center"><img src="images/btn_file-manager_bg.gif" width="25" height="25" border="0" style="cursor:pointer" 
                        onclick="opennewsletter('admin','Administrator'); return false"  /></td>
                        <td align="center"><img src="images/key.gif" border="0" style="cursor:pointer" 
                ...
                if(!$rs->EOF) {
                   ...
                   // while(!$rs->EOF) {
						...
						$href_link = "index.php?data=".base64_encode('user;staff/user_form.php;admin;user;'.$rs->fields['staff_id']);
						
                        ?>
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            <td valign="top" align="right"><?=$bil;?>.</td>
			             	<td valign="top" align="left"><a href="<?=$href_link;?>"><? echo stripslashes($rs->fields['fld_staff']);?></a>&nbsp;</td>
                            <td valign="top"><? echo $rs->fields['fld_kp'];?>&nbsp;</td>
                            <td valign="top">
                             	<? 	if($rs->fields['is_pensyarah']=='Y'){ print 'Pensyarah, '; }
								...
								?>
                            &nbsp;</td>
                            <td valign="top"><? echo $rs->fields['flduser_name'];?>&nbsp;</td>
    						<td align="center"><img src="images/btn_file-manager_bg.gif" width="25" height="25" border="0" style="cursor:pointer" 
                            onclick="opennewsletter('<?=$rs->fields['staff_id'];?>','<? print addslashes($rs->fields['fld_staff']);?>'); return false"  /></td>
    						<td align="center"><img src="images/key.gif" border="0" style="cursor:pointer" 
                            onclick="reset_pass('<?=$rs->fields['staff_id'];?>','<? print addslashes($rs->fields['fld_staff']);?>'); return false"  /></td>
                        </tr>
                        <?
                        $cnt = $cnt + 1;
                        $bil = $bil + 1;
