...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td>&nbsp;&nbsp;
            ...
            <? } ?>
                <? while(!$rsk->EOF) { ?>
                <option value="<?=$rsk->fields['kid'];?>" <? if($kategori==$rsk->fields['kid']){ print 'selected';}?>><?=$rsk->fields['kursus'];?></option>
                <? $rsk->MoveNext(); } ?>
            </select>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>&nbsp;&nbsp;
            ...
            <? } ?>
                <? while(!$rsp->EOF) { ?>
                <option value="<?=$rsp->fields['pusat_id'];?>" <? if($pusat_id==$rsp->fields['pusat_id']){ print 'selected';}?>
    ...
    <tr>
        ...
        <td>&nbsp;&nbsp;
            <select name="get_sesi" onchange="do_post()">
                ...
                <? while(!$rss->EOF) { ?>
                <option value="<?=$rss->fields['sesi_id'];?>" <? if($get_sesi==$rss->fields['sesi_id']){ print 'selected';}?>><?=$rss->fields['sesi'];?></option>
                <? $rss->MoveNext(); } ?>
            </select>
        </td>
    </tr>
