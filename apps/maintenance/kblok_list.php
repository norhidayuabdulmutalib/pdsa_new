...
if(!empty($href_directory)){
	$href_search = "index.php?data=".base64_encode('user;asrama/menu_asrama.php;asrama;kblok;;../apps/maintenance/kblok_list.php');
} else {
	$href_search = "index.php?data=".base64_encode('user;maintenance/kblok_list.php;admin;kblok');
} 
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        <td height="30" colspan="3" valign="middle">
			...
			<? $new_page = "modal_form.php?win=".base64_encode($href_directory.'maintenance/kblok_form.php;');?>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['f_kb_desc']);?>&nbsp;<?//=$cntk;?></td>
                            <td valign="top" align="center">
                            	<? if($rs->fields['f_kb_status']=='0'){ print 'Aktif'; }
