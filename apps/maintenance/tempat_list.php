...
$href_search = "index.php?data=".base64_encode('user;maintenance/tempat_list.php;admin;tempat');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<? $new_page = "modal_form.php?win=".base64_encode('maintenance/tempat_form.php;');?>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="center"><? echo stripslashes($rs->fields['f_tbcode']);?>&nbsp;</td>
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['f_tempat_nama']);?>&nbsp;</td>
            				<td valign="top" align="left"><? echo stripslashes(dlookup("_ref_tempat_kategori","ref_kt_nama","ref_ktid=".tosql($rs->fields['ref_ktid'])));?>&nbsp;</td>
