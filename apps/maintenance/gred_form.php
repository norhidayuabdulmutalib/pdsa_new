            ...
            <tr>
                ...
                <td width="50%" colspan="2">
                	<select name="f_jawatan">
                    	<option value="0" <? if($rs->fields['f_jawatan']=='0'){ print 'selected'; }?>>-</option>
                    	<option value="1" <? if($rs->fields['f_jawatan']=='1'){ print 'selected'; }?>>Sokongan</option>
                    	<option value="2" <? if($rs->fields['f_jawatan']=='2'){ print 'selected'; }?>>P & P</option>
                    	<option value="3" <? if($rs->fields['f_jawatan']=='3'){ print 'selected'; }?>>Jusa</option>
                    </select>
                </td>
            </tr>
            <tr>
