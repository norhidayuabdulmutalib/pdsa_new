...
$href_search = "index.php?data=".base64_encode('user;maintenance/pusat_list.php;admin;pusat');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        <td height="30" colspan="3" valign="middle">
	        ...
	        &nbsp;&nbsp;<strong>SENARAI MAKLUMAT RUJUKAN PUSAT KURSUS</strong></font>
        	<div style="float:right">
			<? $new_page = "modal_form.php?win=".base64_encode($href_directory.'maintenance/pusat_form.php;');?>
        	<input type="button" value="Tambah Rujukan Pusat Kursus" style="cursor:pointer" 
            onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Rujukan Pusat Kursus',700,400)" />&nbsp;&nbsp;</div>
        </td>
    </tr>
    <tr>
        <td colspan="5" align="center">
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                <tr bgcolor="#CCCCCC">
                    ...
                    <td width="75%" align="center"><b>Maklumat Pusat Kursus</b></td>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['jabatan_nama']);?>&nbsp;</td>
                            <td valign="top" align="center">
                            	<? if($rs->fields['jabatan_status']=='0'){ print 'Aktif'; }
                            ...
                            <td align="center">
                                ...
                                onclick="do_hapus('_ref_aras_bangunan','<?=$rs->fields['jabatan_id'];?>','<?=$href_directory;?>')" />
                                <?php } ?>
                            </td>
                        </tr>
                        <?
