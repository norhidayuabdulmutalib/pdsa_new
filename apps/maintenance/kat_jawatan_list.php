...
$href_search = "index.php?data=".base64_encode('user;maintenance/kat_jawatan_list.php;admin;kblok');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<? $new_page = "modal_form.php?win=".base64_encode('maintenance/kat_jawatan_form.php;');?>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['f_kg_desc']);?>&nbsp;</td>
                            <td valign="top" align="center">
                            	<? if($rs->fields['f_kg_status']=='0'){ print 'Aktif'; }
