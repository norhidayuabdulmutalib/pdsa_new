...
if(!empty($href_directory)){
	$href_search = "index.php?data=".base64_encode('user;asrama/menu_asrama.php;asrama;blok;;../apps/maintenance/blok_list.php');
} else {
	$href_search = "index.php?data=".base64_encode('user;maintenance/blok_list.php;admin;blok');
} 
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <font size="2" face="Arial, Helvetica, sans-serif"><strong>SENARAI MAKLUMAT RUJUKAN BLOK BANGUNAN</strong></font>
        	...
        	<? $new_page = "modal_form.php?win=".base64_encode($href_directory.'maintenance/blok_form.php;');?>
