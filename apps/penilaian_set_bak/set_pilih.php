...
$href_search = "modal_form.php?win=".base64_encode('penilaian_set/set_pilih.php;')."&id=".$id."&id_bhg=".$id_bhg;
?>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td width="60%" align="left">&nbsp;
			...
			<input type="hidden" size="10" name="id" value="<? echo $id;?>">
			<input type="hidden" size="10" name="id_bhg" value="<? echo $id_bhg;?>">
		</td>
	</tr>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
							...
							<? echo stripslashes($rs->fields['f_penilaian_desc']);?>&nbsp;</td>
            				<td valign="top" align="left"><? echo stripslashes($kat_penilaian);?>&nbsp;</td>
                        </tr>
                        <?
						$bil++;
                        $rs->movenext();
