...
$cnt = $rs->recordcount();
$href_bahagian = "modal_form.php?win=".base64_encode('penilaian_set/set_penilaian_kursus_bahagian.php;')."&pset_id=".$id;
$href_borang = "modal_form.php?win=".base64_encode('penilaian_set/cetak_borang_penilaian.php;')."&pset_id=".$id;
?>
