...
$href_search = "index.php?data=".base64_encode('user;penilaian_set/set_penilaian_kursus.php;nilai;set_nilai');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<? $new_page = "index.php?data=".base64_encode('user;penilaian_set/set_penilaian_kursus_form.php;nilai;set_nilai');?>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                		...
                		$href_link = "index.php?data=".base64_encode('user;penilaian_set/set_penilaian_kursus_form.php;nilai;set_nilai;'.$rs->fields['pset_id']);
                        ?>
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            <td valign="top" align="right"><?=$bil;?>.</td>
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['pset_tajuk']);?>&nbsp;</td>
            				<td valign="top" align="center"><? echo stripslashes(DisplayDate($rs->fields['create_dt']));?>&nbsp;</td>
                            <td valign="top" align="center">
                            	<? if($rs->fields['pset_status']=='0'){ print 'Aktif'; }
