...
$href_search = "index.php?data=".base64_encode('user;penilaian/set_penilaian.php;nilai;set');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<? $new_page = "index.php?data=".base64_encode('user;penilaian/set_penilaian_form.php;nilai;set');?>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                		...
                		$href_link = "index.php?data=".base64_encode('user;penilaian/set_penilaian_form.php;nilai;set;'.$rs->fields['pset_id']);
                        ?>
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            ...
                            <td align="center">
                                ...
                                onclick="do_page('<?=$href_link;?>&pro=DELETE')"/>
                            </td>
                        </tr>
                        <?
                        $cnt = $cnt + 1;
