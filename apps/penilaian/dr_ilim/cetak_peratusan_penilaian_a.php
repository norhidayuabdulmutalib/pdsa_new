...
<table width="98%" align="center" cellpadding="0" cellspacing="0" border="0">
  ...
  <TBODY style="width:100%">
	...
	if(!empty($jum_nilai)){ $pct_jum_pumur = ($jum_pumur/$jum_nilai)*100; }
	...
	if(!empty($jum_nilai)){ $pct_jum_jantina = ($jum_jantina/$jum_nilai)*100; }
	...
	if(!empty($jum_nilai)){ $pct_jum_jawatan = ($jum_jawatan/$jum_nilai)*100; }
	...
	if(!empty($jum_nilai)){ $pct_jum_kkursus = ($jum_kkursus/$jum_nilai)*100; }
	?>
            ...
            ?>
				...
				?>
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td align="center"><strong><?php if(!empty($jum_nilai)){ print number_format(($jum_set/$jum_nilai)*100,2); }?>%</strong></td>
                            </tr>
