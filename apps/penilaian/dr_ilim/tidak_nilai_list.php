...
AND A.InternalStudentAccepted=1 AND A.InternalStudentId NOT IN (SELECT id_peserta FROM _tbl_set_penilaian_peserta WHERE event_id=".tosql($id).")";
	...
	<tr><td colspan="3">
        <table width="96%" cellpadding="4" cellspacing="0" border="1" align="center">
            ...
            <tr>
                ...
                <td align="left"><?php print $rs_det->fields['f_peserta_nama'];?><br /><i>No. KP: <?php print $rs_det->fields['f_peserta_noic'];?></i>&nbsp;</td>
