  ...
  <TBODY style="width:100%">
	...
	<tr><td colspan="5"><table width="100%" border="1" cellpadding="5" cellspacing="0">
        ...
        <tr>
            ...
            <td align="center"><?php
            $sqlj = "SELECT A.* FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND A.is_selected IN (1,9) AND D.ref_ktid=2 AND  A.InternalStudentAccepted=1 
			AND B.is_deleted=0 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
			$sqlj = "SELECT A.* FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND A.is_selected IN (1,9) AND D.ref_ktid=3 AND A.InternalStudentAccepted=1 
			AND B.is_deleted=0 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
            $sqlj = "SELECT A.* FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND A.is_selected IN (1,9) AND D.ref_ktid=4 AND A.InternalStudentAccepted=1 
			AND B.is_deleted=0 AND A.EventId=".tosql($id);
        ...
        $sqljlain = "SELECT distinct B.BranchCd FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND A.is_selected IN (1,9) AND D.ref_ktid>=5 AND A.InternalStudentAccepted=1 
			AND B.is_deleted=0 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
				...
				WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND A.is_selected IN (1,9) AND A.InternalStudentAccepted=1 AND D.ref_ktid>=5  
        ...
        <tr>
			...
			WHERE A.peserta_icno=B.f_peserta_noic AND A.InternalStudentAccepted=1 AND B.BranchCd='0099' AND A.is_selected IN (1,9) AND B.is_deleted=0 AND A.EventId=".tosql($id);
			//print $sqlj;
