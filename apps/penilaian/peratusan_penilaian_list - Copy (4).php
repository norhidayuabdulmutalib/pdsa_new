...
if($proses=='PROSES'){
	...
	$rs = &$conn->Execute($sql);
	if(!$rs->EOF){
		$jum = dlookup("_tbl_set_penilaian_peserta","count(*)","event_id=".tosql($id));
		...
		$jawatan_p = dlookup("_tbl_set_penilaian_peserta","count(*)","fsetp_pp=1 AND event_id=".tosql($id));
		$jawatan_s = dlookup("_tbl_set_penilaian_peserta","count(*)","fsetp_sokongan=1 AND event_id=".tosql($id));
...
<table width="98%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
        ...
        <td><strong>Jumlah Kehadiran : <?php print $jum_hadir;?></strong> peserta hadir
        	...
        	<input type="text" name="jum_online" size="3" value="<?=$jum_nilai;?>" readonly="readonly" disabled="disabled" /> = 
        	<input type="text" name="jk" size="3" value="<?php print $jhadir;?>" readonly="readonly" disabled="disabled" />
        </td>
        <td><strong>Jumlah Menilai : <?php print $jum_nilai;?></strong> peserta 
        <?php //$conn->debug=true;
			...
			//$sqlsel = "SELECT distinct id_peserta FROM _tbl_set_penilaian_peserta_bhg WHERE event_id=".tosql($id);
	...
	<tr><td colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="1">
      <tr>
        ...
        <td width="17%">
        	<input type="text" size="1" name="fset_umur19_off" value="<?php print $rs_nilai->fields['fset_umur19_off'];?>" style="text-align:center" 
            	onchange="disp_val_main('<?php print $id;?>','fset_umur19_off','fset_umur19','umur_19',this.form)" />
        	<input type="text" size="1" name="fset_umur19" value="<?php print $rs_nilai->fields['fset_umur19'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="umur_19" value="<?php print $rs_nilai->fields['fset_umur19_off']+$rs_nilai->fields['fset_umur19'];?>" style="text-align:center" disabled="disabled"/>
            (<input type="text" size="1" name="umur_all" value="<?php print $jum_all_umur;?>" style="text-align:center" disabled="disabled"/>)        
        </td>
        <td width="2%">&nbsp;</td>
        <td width="18%">2. Jantina :</td>
        <td width="10%">Lelaki</td>
        <td width="17%">
        	<input type="text" size="1" name="fset_jantina_l_off" value="<?php print $rs_nilai->fields['fset_jantina_l_off'];?>" style="text-align:center" 
            	onchange="disp_val_main('<?php print $id;?>','fset_jantina_l_off','fset_jantina_l','jantina_l',this.form)" />
        	<input type="text" size="1" name="fset_jantina_l" value="<?php print $rs_nilai->fields['fset_jantina_l'];?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="1" name="jantina_l" value="<?php print $rs_nilai->fields['fset_jantina_l_off']+$rs_nilai->fields['fset_jantina_l'];?>" 
            	style="text-align:center" disabled="disabled"/>
			 (<input type="text" size="1" name="umur_all2" value="<?php print $rs_nilai->fields['fset_jantina_l_off']+$rs_nilai->fields['fset_jantina_l']+
      ...
      <tr>
        ...
        <td>20-29 tahun</td>
        <td>
        	<input type="text" size="1" name="fset_umur20_off" value="<?php print $rs_nilai->fields['fset_umur20_off'];?>" style="text-align:center" 
            	onchange="disp_val_main('<?php print $id;?>','fset_umur20_off','fset_umur20','umur_20',this.form)" />
        	<input type="text" size="1" name="fset_umur20" value="<?php print $rs_nilai->fields['fset_umur20'];?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="1" name="umur_20" value="<?php print $rs_nilai->fields['fset_umur20_off']+$rs_nilai->fields['fset_umur20'];?>" style="text-align:center" disabled="disabled"/>        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>Perempuan</td>
        <td>
        	<input type="text" size="1" name="fset_jantina_p_off" value="<?php print $rs_nilai->fields['fset_jantina_p_off'];?>" style="text-align:center" 
            	onchange="disp_val_main('<?php print $id;?>','fset_jantina_p_off','fset_jantina_p','jantina_p',this.form)" />
        	<input type="text" size="1" name="fset_jantina_p" value="<?php print $rs_nilai->fields['fset_jantina_p'];?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="1" name="jantina_p" value="<?php print $rs_nilai->fields['fset_jantina_p_off']+$rs_nilai->fields['fset_jantina_p'];?>" readonly="readonly"style="text-align:center" disabled="disabled"/>        
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>30-39 tahun</td>
        <td>
        	<input type="text" size="1" name="fset_umur30_off" value="<?php print $rs_nilai->fields['fset_umur30_off'];?>" style="text-align:center" 
            	onchange="disp_val_main('<?php print $id;?>','fset_umur30_off','fset_umur30','umur30',this.form)" />
        	<input type="text" size="1" name="fset_umur30" value="<?php print $rs_nilai->fields['fset_umur30'];?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="1" name="umur30" value="<?php print $rs_nilai->fields['fset_umur30_off']+$rs_nilai->fields['fset_umur30'];?>" style="text-align:center" disabled="disabled" />        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>40-49 tahun</td>
        <td>
        	<input type="text" size="1" name="fset_umur40_off" value="<?php print $rs_nilai->fields['fset_umur40_off'];?>" style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_umur40_off','fset_umur40','umur_40',this.form)" />
        	<input type="text" size="1" name="fset_umur40" value="<?php print $rs_nilai->fields['fset_umur40'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="umur_40" value="<?php print $rs_nilai->fields['fset_umur40_off']+$rs_nilai->fields['fset_umur40'];?>" style="text-align:center" disabled="disabled"/>        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>
        	<input type="text" size="1" name="fset_umur50_off" value="<?php print $rs_nilai->fields['fset_umur50_off'];?>" style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_umur50_off','fset_umur50','umur_50',this.form)" />
        	<input type="text" size="1" name="fset_umur50" value="<?php print $rs_nilai->fields['fset_umur50'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="umur_50" value="<?php print $rs_nilai->fields['fset_umur50_off']+$rs_nilai->fields['fset_umur50'];?>" style="text-align:center" disabled="disabled"/> 
			</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>JUSA</td>
        <td>
        	<input type="text" size="1" name="fset_jusa_off" value="<?php print $rs_nilai->fields['fset_jusa_off'];?>" style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_jusa_off','fset_jusa','jusa',this.form)" />
        	<input type="text" size="1" name="fset_jusa" value="<?php print $rs_nilai->fields['fset_jusa'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="jusa" value="<?php print $rs_nilai->fields['fset_jusa_off']+$rs_nilai->fields['fset_jusa'];?>" style="text-align:center" disabled="disabled"/>
			 (<input type="text" size="1" name="umur_all4" value="<?php print $rs_nilai->fields['fset_jusa_off']+$rs_nilai->fields['fset_jusa']+$rs_nilai->fields['fset_pp_off']+$rs_nilai->fields['fset_pp']+$rs_nilai->fields['fset_sokongan_off']+$rs_nilai->fields['fset_sokongan'];?>" style="text-align:center" disabled="disabled"/>)        
        </td>
        <td>&nbsp;</td>
        <td>4. kekerapan Kursus di ILIM</td>
        <td>Pertama</td>
        <td>
        	<input type="text" size="1" name="fset_pertama_off" value="<?php print $rs_nilai->fields['fset_pertama_off'];?>"style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_pertama_off','fset_pertama','pertama',this.form)" />
        	<input type="text" size="1" name="fset_pertama" value="<?php print $rs_nilai->fields['fset_pertama'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="pertama" value="<?php print $rs_nilai->fields['fset_pertama_off']+$rs_nilai->fields['fset_pertama'];?>" style="text-align:center" disabled="disabled" />
			 (<input type="text" size="1" name="umur_all3" value="<?php print $rs_nilai->fields['fset_pertama_off']+$rs_nilai->fields['fset_pertama']+$rs_nilai->fields['fset_kedua_off']+$rs_nilai->fields['fset_kedua']+$rs_nilai->fields['fset_ketiga_off']+$rs_nilai->fields['fset_ketiga'];?>" style="text-align:center" disabled="disabled"/>)        
         </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>P&amp;P</td>
        <td>
        	<input type="text" size="1" name="fset_pp_off" value="<?php print $rs_nilai->fields['fset_pp_off'];?>" style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_pp_off','fset_pp','pp',this.form)" />
        	<input type="text" size="1" name="fset_pp" value="<?php print number_format($rs_nilai->fields['fset_pp'],0);?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="pp" value="<?php print $rs_nilai->fields['fset_pp_off']+$rs_nilai->fields['fset_pp'];?>" style="text-align:center" disabled="disabled" />        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>Kedua</td>
        <td>
        	<input type="text" size="1" name="fset_kedua_off" value="<?php print $rs_nilai->fields['fset_kedua_off'];?>" style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_kedua_off','fset_kedua','kedua',this.form)" />
        	<input type="text" size="1" name="fset_kedua" value="<?php print $rs_nilai->fields['fset_kedua'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="kedua" value="<?php print $rs_nilai->fields['fset_kedua_off']+$rs_nilai->fields['fset_kedua'];?>" style="text-align:center" disabled="disabled" />        
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>Sokongan</td>
        <td>
        	<input type="text" size="1" name="fset_sokongan_off" value="<?php print $rs_nilai->fields['fset_sokongan_off'];?>" style="text-align:center" 
            	onchange="disp_val_main('<?php print $id;?>','fset_sokongan_off','fset_sokongan','sokongan',this.form)" />
        	<input type="text" size="1" name="fset_sokongan" value="<?php print number_format($rs_nilai->fields['fset_sokongan'],0);?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="sokongan" value="<?php print $rs_nilai->fields['fset_sokongan_off']+$rs_nilai->fields['fset_sokongan'];?>" style="text-align:center" disabled="disabled" />        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>Lebih dari dua</td>
        <td>
        	<input type="text" size="1" name="fset_ketiga_off" value="<?php print $rs_nilai->fields['fset_ketiga_off'];?>" style="text-align:center"  
            	onchange="disp_val_main('<?php print $id;?>','fset_ketiga_off','fset_ketiga','ketiga',this.form)" />
        	<input type="text" size="1" name="fset_ketiga" value="<?php print $rs_nilai->fields['fset_ketiga'];?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="1" name="ketiga" value="<?php print $rs_nilai->fields['fset_ketiga_off']+$rs_nilai->fields['fset_ketiga'];?>" style="text-align:center" disabled="disabled" />        
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <tr>
			...
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=1 AND A.is_sijil=1 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
            $sqlj = "SELECT A.* as cnt FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=2 AND A.is_sijil=1 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
			$sqlj = "SELECT A.* as cnt FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=3 AND A.is_sijil=1 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
            $sqlj = "SELECT A.* as cnt FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=4 AND A.is_sijil=1 AND A.EventId=".tosql($id);
        ...
        $sqljlain = "SELECT distinct B.BranchCd FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
					WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=5 AND A.is_sijil=1 AND A.EventId=".tosql($id);
        ...
        <tr>
            ...
            <td align="center"><?php
				...
				WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=5 AND A.is_sijil=1 
				AND A.EventId=".tosql($id)." AND B.BranchCd=".$rsjlain->fields['BranchCd'];
      ...
      <tr>
		...
		<table width="100%" border="1" cellpadding="5" cellspacing="0">
            ...
            $sqljlain = "SELECT count(*) as grades, B.f_title_grade FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B
                        WHERE A.peserta_icno=B.f_peserta_noic AND A.is_sijil=1 AND A.EventId=".tosql($id)." GROUP BY B.f_title_grade";
            $rsjlain = &$conn->Execute($sqljlain); 
        ...
        <td colspan="1" valign="top">
            <table width="100%" border="1" cellpadding="5" cellspacing="0">
                ...
                <?php
                $cntn=0; $cntn_jum=0;//$conn->debug=true;
                $sqljlain = "SELECT count(*) as negeris, B.f_peserta_negeri FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B
                            WHERE A.peserta_icno=B.f_peserta_noic AND A.is_sijil=1 AND A.EventId=".tosql($id)." GROUP BY B.f_peserta_negeri";
                $rsjlain = &$conn->Execute($sqljlain); 
...
$fset_id = $rs->fields['fset_id'];
	...
	$sql_det = "SELECT A.*, B.nilai_keterangan FROM _tbl_set_penilaian_bhg A, _tbl_nilai_bahagian B, _tbl_kursus_jadual_masa C
	WHERE A.fsetb_nilaib_id=B.nilaib_id AND A.fsetb_event_id=".tosql($id)." AND A.fset_id=".tosql($fset_id);
	$sql_det .= " AND A.fsetb_event_id=C.event_id ORDER BY C.tarikh, C.masa_mula "; //" ORDER BY sorts"; //print $sql_det;
