	...
	<tr><td colspan="2">
    	<table width="90%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" size="30" name="SubCategoryNm" maxlength="20" value="<? print $rs->fields['SubCategoryNm'];?>"/> <i></i></td>
            </tr>
            <tr>
                <td width="30%"><b>Diskripsi Unit / Pusat : </b></td>
                <td width="50%" colspan="2"><input type="text" size="60" name="SubCategoryDesc" value="<? print $rs->fields['SubCategoryDesc'];?>" /></td>
            </tr>
            <tr>
