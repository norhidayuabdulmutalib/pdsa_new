...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="1">
    <tr>
    	<td colspan="2" class="title" height="25">SELENGGARA MAKLUMAT KURSUS</td>
    </tr>
	<tr><td colspan="2">
    	<table width="90%" cellpadding="4" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <td width="70%" align="left" colspan="2">
                	<input type="text" size="10" name="courseid" maxlength="10" value="<? print $rs->fields['courseid'];?>"/> <i>Cth: C0001</i></td>
            </tr>
            <tr>
                <td align="right"><b><font color="#FF0000">*</font> Nama Kursus : </b></td>
                <td align="left" colspan="2" >
                	<input type="text" size="80" name="coursename" value="<? print $rs->fields['coursename'];?>" style="width:98%" /></td>
            </tr>
            ...
            <tr>
                ...
                <td width="70%" align="left" colspan="2">
                	<input type="text" size="10" name="coursefees" value="<? print number_format($rs->fields['coursefees'],2);?>"/>
            ...
            <tr>
                ...
                <td width="70%" align="left" colspan="2">
                	<textarea name="objektif" rows="3" cols="60" style="width:98%"><? print $rs->fields['objektif'];?></textarea>
                </td>
            </tr>
            <tr>
                <td width="30%" align="right"><b>Kandungan Kursus : </b></td>
                <td width="70%" align="left" colspan="2">
                	<textarea name="kandungan" rows="3" cols="60" style="width:98%"><? print $rs->fields['kandungan'];?></textarea>
                </td>
            </tr>
            <tr>
                <td width="30%" align="right"><b>Kumpulan Sasar : </b></td>
                <td width="70%" align="left" colspan="2">
                	<textarea name="ksasar" rows="3" cols="60" style="width:98%"><? print $rs->fields['ksasar'];?></textarea>
                </td>
            </tr>
            <tr>
                <td width="30%" align="right"><b>Komen : </b></td>
                <td width="70%" align="left" colspan="2">
                	<textarea name="coursedesc" rows="3" cols="60" style="width:98%"><? print $rs->fields['coursedesc'];?></textarea>
                </td>
            </tr>
            <tr>
