	...
	<tr><td colspan="2">
    	<table width="90%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" size="10" name="category_code" maxlength="5" value="<? print $rs->fields['category_code'];?>"/> <i>Cth: C0001</i></td>
            </tr>
            <tr>
                <td width="30%"><b>Kategori Kursus : </b></td>
                <td width="50%" colspan="2"><input type="text" size="60" name="categorytype" value="<? print $rs->fields['categorytype'];?>" /></td>
            </tr>
            <tr>
