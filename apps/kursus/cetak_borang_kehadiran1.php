...
$sql_det = "SELECT A.*, B.f_peserta_nama, B.f_peserta_noic, B.BranchCd 
...
<table width="100%" align="center" cellpadding="4" cellspacing="0" border="0">
    ...
    <?php
	$ddiff = get_datediff($rs->fields['startdate'],$rs->fields['enddate']);
	//print "<br>".$ddiff;
    ?>
	<tr><td colspan="3">
        <table width="100%" cellpadding="4" cellspacing="0" border="1" align="center">

            <tr bgcolor="#CCCCCC"><td colspan="<?=$ddiff+4;?>"><b>Senarai peserta bagi kursus : <?php print $rs->fields['courseid'] . " - " .$rs->fields['coursename'];?> 
            - <u>TARIKH : <?php print DisplayDate($rs->fields['startdate']);?> hingga <?php print DisplayDate($rs->fields['enddate']);?></u></b></td></tr>
            <tr bgcolor="#CCCCCC">
                <td width="5%" align="center" rowspan="2"><b>Bil</b></td>
                <td width="30%" align="center" rowspan="2"><b>Nama Peserta</b></td>
                <td width="10%" align="center" rowspan="2"><b>No. KP</b></td>
                <td width="30%" align="center" rowspan="2"><b>Agensi/Jabatan/Unit</b></td>
                <td width="25%" align="center" colspan="<?=$ddiff;?>"><b>Tandatangan</b></td>
            </tr>
            <tr bgcolor="#CCCCCC">
            	<?php for($i=0;$i<$ddiff;$i++){ ?>
                <td align="center"><b><?=get_jadualdt($rs->fields['startdate'],$rs->fields['enddate'],$i);?></b></td>
                <?php } ?>
            </tr>
            <?php while(!$rs_det->EOF){ $bil++; ?>
            <tr>
                <td align="right" height="45px"><?php print $bil;?>.&nbsp;</td>
