...
$href_search = "index.php?data=".base64_encode('user;kursus/ref_kategori_kursus_list.php;kursus;c');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<? $new_page = "modal_form.php?win=".base64_encode('kursus/ref_kategori_kursus_form.php;');?>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['category_code']);?>&nbsp;</td>
            				<td valign="top" align="left"><? echo stripslashes($rs->fields['categorytype']);?>&nbsp;</td>
