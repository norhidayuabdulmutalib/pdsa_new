	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" name="f_peserta_email" size="50" value="<? print $rs->fields['f_peserta_email'];?>"></td>
            </tr>
            <tr>
          ...
          <tr>
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" name="f_waris_nama" size="50" value="<? print $rs->fields['f_waris_nama'];?>"></td>
            </tr>
            <tr>
                <td valign="top" align="left"><b>Alamat Waris : </b></td>
                <td colspan="2"><input type="text" name="f_waris_alamat1" size="50" value="<? print $rs->fields['f_waris_alamat1'];?>" /></td>
            </tr>
            <tr>
                <td valign="top" align="left">&nbsp;</td>
                <td colspan="2"><input type="text" name="f_waris_alamat2" size="50" value="<? print $rs->fields['f_waris_alamat2'];?>" /></td>
            </tr>
            <tr>
                <td valign="top">&nbsp;</td>
                <td colspan="2"><input type="text" name="f_waris_alamat3" size="50" value="<? print $rs->fields['f_waris_alamat3'];?>" /></td>
            </tr>
            <tr>
