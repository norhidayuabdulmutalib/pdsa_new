...
<ul class="menu5">
    ...
    <li <? if($_SESSION['menu']=='default'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;default.php;default');?>"><b>Muka Hadapan</b></a></li>
<? while(!$rs_menu->EOF){ ?>
    <li <? if($_SESSION['menu']==$rs_menu->fields['grp_kod']){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode($rs_menu->fields['menu_link']);?>"><b><? print $rs_menu->fields['grp_name'];?><?//=$rs_menu->fields['grp_kod'];?></b></a></li>
<? 		$rs_menu->movenext();
	}
?>
	</div>
