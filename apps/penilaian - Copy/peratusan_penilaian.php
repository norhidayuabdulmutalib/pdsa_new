...
$href_search = "index.php?data=".base64_encode('user;penilaian/peratusan_penilaian.php;nilai;peratus');
?>
            ...
            <table width="100%" border="1" cellpadding="4" cellspacing="0">
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
						...
						$href_borang = "modal_form.php?win=".base64_encode('penilaian_set/cetak_peratusan_penilaian.php;'.$rs->fields['id']);
                        ?>
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            ...
                            <td align="center">
                            	<img src="../img/icon-info1.gif" width="25" height="25" style="cursor:pointer" title="Sila klik untuk paparan jumpah peratusan penilaian" 
