...
$href_search = "modal_form.php?win=".base64_encode('penilaian/set_pilih.php;')."&id=".$id;
?>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td width="60%" align="left">&nbsp;
			...
			<input type="text" size="10" name="id" value="<? echo $id;?>">
		</td>
	</tr>
	...
	if($proses=='PILIH'){
		for($i=0;$i<$bil;$i++){
			if($_POST['del'][$i]=='on'){
				...
				$sql = "INSERT INTO _tbl_penilaian_det_detail(pset_id, f_penilaian_detailid, f_status) 
				VALUES(".tosql($id,"Text").", ".tosql($pdet_id,"Text").", 0)";
				//print $sql."<br>";	
				$conn->Execute($sql);
			}
		}
		...
		$sql = "DELETE FROM _tbl_penilaian_det_detail WHERE pset_detailid=".tosql($iddel);
		$conn->Execute($sql);
