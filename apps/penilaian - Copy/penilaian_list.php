...
$href_search = "index.php?data=".base64_encode('user;penilaian/penilaian_list.php;nilai;penilaian');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<? $new_page = "modal_form.php?win=".base64_encode('penilaian/penilaian_form.php;');?>
        	<input type="button" value="Tambah Maklumat Rujukan Penilaian" style="cursor:pointer" 
            onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Rujukan Penilaian',700,400)" />&nbsp;&nbsp;
        </td>
    </tr>
    <tr>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><? echo $kat_penilaian;?>&nbsp;</td>
                            <td valign="top" align="center">
                            	<? if($rs->fields['f_penilaian_jawab']=='1'){ print 'Set 5 Pilihan'; }
                            ...
                            <td align="center">
                                ...
                                onclick="open_modal('<?=$href_link;?>','Kemaskini Maklumat Rujukan Penilaian',700,400)" />
                                <?php if($cntk==0){ ?>
