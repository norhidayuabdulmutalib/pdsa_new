...
if(!empty($proses)){ 
	...
	if($proses=='SAVE'){
		...
		if(empty($id)){
			...
			VALUES(".tosql($pset_tajuk,"Text").",".tosql($pset_tajuk,"Text").", ".tosql($pset_status,"Number").",
    	...
    	<table width="80%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    onClick="form_hantar('index.php?data=<? print base64_encode('user;penilaian/set_penilaian.php;nilai;set;');?>')" >
