...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="1">
	...
	<tr><td colspan="2">
    	<table width="90%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <? } ?>
            <tr>
                <td width="30%"><b>Maklumat Penilaian : </b></td>
                <td width="50%" colspan="2"><input type="text" size="50" name="f_penilaian_desc" value="<?php print $rs->fields['f_penilaian_desc'];?>" /></td>
            </tr>
            ...
            <tr>
                ...
                <td width="50%" colspan="2">
                    ...
                    <?php $rs_kb->movenext(); } ?>
                    	<option value="A" <? if($rs->fields['f_penilaianid']=='A'){ print 'selected'; }?>>Keseluruhan Kursus</option>
                    	<option value="B" <? if($rs->fields['f_penilaianid']=='B'){ print 'selected'; }?>>Cadangan Penambahbaikan</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td width="50%" colspan="2">
                	<select name="f_penilaian_jawab">
                    	<option value="0" <? if($rs->fields['f_penilaian_jawab']=='0'){ print 'selected'; }?>>-</option>
                    	<option value="1" <? if($rs->fields['f_penilaian_jawab']=='1'){ print 'selected'; }?>>Set 5 Pilihan</option>
                    	<option value="2" <? if($rs->fields['f_penilaian_jawab']=='2'){ print 'selected'; }?>>Set Ya / Tidak</option>
                    	<option value="3" <? if($rs->fields['f_penilaian_jawab']=='3'){ print 'selected'; }?>>Set Jawapan Bertulis</option>
                    </select>
                </td>
            </tr>
            <tr>
