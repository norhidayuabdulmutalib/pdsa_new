	...
	<tr><td colspan="2">
    	...
    	<table width="90%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <tr>
              ...
              <td width="70%" colspan="2"><select name="inpakar_bidang">
                        <?php 
                                ...
                                <option value="<?=$row_gred['f_pakar_code'] ?>" <?php if($rs->fields['inpakar_bidang'] == $row_gred['f_pakar_code']) echo "selected"; ?> >
								<?=$row_gred['f_pakar_nama']?></option>
                        <?php }?>        
                   </select></td>
            </tr>
			<tr>
