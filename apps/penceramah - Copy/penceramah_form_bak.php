          ...
          <tr>
            ...
            <tr>
 			...
 			<tr>
                ...
                <td width="80%" colspan="3">RM<input type="text" name="payperhours" value="<? print $rs->fields['payperhours'];?>" />(Masukkan angka sahaja!)</td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" name="insbank"  size="65" value="<? print $rs->fields['insbank'];?>" /></td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" name="insbankbrch"  size="65" value="<? print $rs->fields['insbankbrch'];?>" /></td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" name="insakaun"  size="65" value="<? print $rs->fields['insakaun'];?>" /></td>
            ...
            <?php if(empty($id)) { ?> onclick="alert('Sila tekan SIMPAN dahulu sebelum menambah maklumat akademik!')" <?php } else { ?> onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Akademik',700,400)" <? } ?> /> &nbsp;&nbsp;</td>
            ...
            <?php if(empty($id)) { ?> onclick="alert('Sila tekan SIMPAN dahulu sebelum menambah bidang kepakaran!')" <?php } else { ?> onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Kepakaran',700,400)" <? } ?> /> &nbsp;&nbsp;</td>
