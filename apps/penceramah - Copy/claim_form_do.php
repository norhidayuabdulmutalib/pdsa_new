...
if(empty($id)){
	...
	$sql = "INSERT INTO _tbl_claim(cl_ins_id,cl_depcd, cl_accoffcd, cl_ptjdesc, cl_ptjcd, 
	...
	VALUES(".tosql($_SESSION['ingenid'],"Text").", ".tosql($cl_depcd,"Text").", ".tosql($cl_accoffcd,"Text").", ".tosql($cl_ptjdesc,"Text").", ".tosql($cl_ptjcd,"Text").", 
	...
	".tosql($cl_elaun,"Text").", ".tosql($cl_gajino,"Text").", ".tosql($cl_orgdesc,"Text").", ".tosql($cl_orgadd,"Text").", 0,  
	...
	$url = base64_encode('user;penceramah/claim_list.php;penceramah;daftar');
	...
	//exit;
		...
		", cl_tarafpost=".tosql($cl_tarafpost,"Text").", cl_gaji=".tosql($cl_gaji,"Number").", cl_elaun=".tosql($cl_elaun,"Text").", cl_gajino=".tosql($cl_gajino,"Text").

		", cl_orgdesc=".tosql($cl_orgdesc,"Text"). ", cl_orgadd=".tosql($cl_orgadd,"Text"). ",update_dt=".tosql(date("Y-m-d H:i:s"),"Text").

		", update_by=".tosql($user,"Text"). " WHERE cl_id =".tosql($id,"Number");
		...
		$url = base64_encode('user;penceramah/claim_list.php;penceramah;daftar;'.$id);
