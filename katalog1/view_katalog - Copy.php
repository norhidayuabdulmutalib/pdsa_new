           ...
           ?>
            <tr>
               ...
               <?php if($btn_display==1){ ?>
                	<img src="../apps/img/delete_btn1.jpg" border="0" width="20" height="20" style="cursor:pointer" onclick="do_hapus('jadual_kursus_ceramah','<?=$idh;?>')" />
                    &nbsp;
                    <img src="../apps/img/printer_icon1.jpg" width="23" height="23" style="cursor:pointer" 
