...
<ul class="menu5">
    ...
    <li <? if($menu=='peserta'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/dmasuk_list.php;peserta;peserta');?>"><b>Daftar Masuk Peserta</b></a></li>
    <li <? if($menu=='kursusluar'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/dmasuk_list_kursusluar.php;kursusluar;kursusluar');?>"><b>Daftar Masuk Peserta Luar</b></a></li>
    <li <? if($menu=='penghuni'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/penghuni_list.php;penghuni;penghuni');?>"><b>Daftar Keluar</b></a></li>
    <li <? if($menu=='kursus'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;kursus/jadual_kursus.php;kursus;kursus');?>"><b>Maklumat Kursus</b></a></li>
    <li <? if($menu=='asrama'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/menu_asrama.php;asrama;asrama');?>"><b>Pentadbiran Asrama</b></a></li>
