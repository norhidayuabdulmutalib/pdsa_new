...
B.perempuan, B.vip, B.penyelaras, B.penyelaras_notel, B.category_code, B.id as idk, B.kampus_id   
...
<table width="90%" cellpadding="5" cellspacing="1" border="0" align="center">
    ...
    <tr>
        ...
        <input type="button" value="Mohon Kursus" style="cursor:pointer" 
  			onclick="do_pages('modal_form.php?win=<?=base64_encode('katalog/mohon.php;');?><?=$link;?>')" />
  		<?php } ?>
  		</div>
      	</td>
    </tr>
