...
if(!empty($proses) && $proses=='DAFTAR'){
	...
	$sSQL="SELECT A.kampus_nama, A.kampus_alamat 
	FROM _ref_kampus A, _tbl_kursus_jadual B 
	WHERE A.kampus_id=B.kampus_id AND id=".tosql($idk);
	$rskampus = &$conn->query($sSQL);
	$kod_kampus = $rskampus->fields['kampus_kod'];
	$nama_kampus = $rskampus->fields['kampus_nama'];
	$alamat_kampus = $rskampus->fields['kampus_alamat'];
...
function form_back(URL){
	document.ilim.action = 'index.php';
	document.ilim.submit();
}
</script>
</head>
