	...
	<div class="container">	
		<div class="row justify-content-center">
			...
			<div class="card-body text-white" style="background-color: rgba(204, 149,	 30, 0.59);">
				...
				<h3 class="section-heading text-uppercase" style="font-size: 2.5em;">SISTEM MAKLUMAT LATIHAN ILIM (I-TIS)<br>(DOMISTIK)<b></h3>  
				...
				<div class="card-body">
					<form class="form-signin-centre">
						...
						<div class="form-group row row align-items-center justify-content-center">
							<label for="logid" class="col-sm-2 col-form-label" style="color:#fff;">No. KP :</label>
							<div class="col-sm-10">
						...
						<div class="form-group row row align-items-center justify-content-center">
							<label for="pass" class="col-sm-2 col-form-label" style="color:#fff;">Kata Laluan</label>
							<div class="col-sm-10">
