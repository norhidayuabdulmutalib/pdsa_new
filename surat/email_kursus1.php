...
$kandungan_email .= '<br><br>Sila klik <a href="itis.islam.gov.my/surat/borang_kehadiran.php?ic='.$f_peserta_noic.'&id='.$EventId.'">disini</a> untuk cetakan borang kehadiran.'; 
/* penerima */
/* To send HTML mail, you can set the Content-type header. */
$headers  = "MIME-Version: 1.0\r\n";
$headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
