...
$message = '
	...
	Assalamualaikum,
	<br><br>
	Adalah dimaklumkan bahawa kursus dibawah ini telah ditangguhkan kepada tarikh yang berikut: <br><br>';

$message .= 	'TAJUK KURSUS : <b>'.$courseid.' - '.$tajuk_kursus.'</b><br>';
$message .=	'TEMPAT KURSUS : <b>'.$tempat.'</b><br>';	
