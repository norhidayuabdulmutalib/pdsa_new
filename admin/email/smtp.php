...
$board_config['smtp_username']='halal@islam.gov.my';
$board_config['smtp_password']='h4l4l';
*/
...
$board_config['board_email']='kursus_ilim@islam.gov.my';

function server_parse($socket, $server_response, $line = __LINE__)
{
