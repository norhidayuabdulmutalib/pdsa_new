...
<link type="text/css" rel="stylesheet" href="../../cal/dhtmlgoodies_calendar3.css?random=20051112" media="screen"></link>
<script type="text/javascript" src="../../cal/dhtmlgoodies_calendar3.js?random=20060118"></script>
	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="1" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <input type="text" name="f_peserta_noic"  value="<?php print $f_peserta_noic;?>" readonly="readonly" style="background-color:#CCCCCC" /></td>
          ...
          <tr>
            ...
            <tr>
                <td colspan="4" align="center"><br>
                    ...
                    onClick="form_hantar('peserta/biodata_update.php')">-->
                     <input type="button" value="Kemaskini" style="cursor:pointer" onclick="form_hantar('biodata_update_view.php?pro=UPDATE')" />
                     <input type="button" value="Tutup" style="cursor:pointer" onclick="do_back()" />
...
<tr>
    <td colspan="4"><br /><?php include 'kursus_dlmproses_view.php'; ?></td>
</tr>
<?php } ?>
</form>
<script LANGUAGE="JavaScript">
...
<?php
	...
	audit_trail($sql,"");
	echo "<meta http-equiv=\"refresh\" content=\"1; URL=biodata_update_view.php?id=&ic=".$f_peserta_noic."\">";
}
?>