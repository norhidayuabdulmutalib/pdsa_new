                	<table width="100%" cellpadding="3" cellspacing="0" border="0">
                    	<tr class="title" >
                        	<td colspan="3"><strong>MAKLUMAT KURSUS LUARAN YANG TELAH DIAMBIL</strong></td>
                ...
                <table width="100%" cellpadding="4" cellspacing="0" border="1">
                    	<tr class="title" bgcolor="#66CCCC">
                            ...
                            <td width="30%"><strong>Nama Kursus</strong></td>
                            <td width="35%"><strong>Tempat Kursus<br><i>Anjuran</i></strong></td>
                            <td width="10%"><strong>Tarikh Mula</strong></td>
                            <td width="10%">audit_trail($sql."")</td>
                            <!--<td width="10%">&nbsp;</td>-->
                        </tr>
                        <?php 	
