          ...
          <tr>
            ...
            <tr>
                <td colspan="4" align="center"><br>
                    ...
                    onClick="form_hantar('index.php?data=<?php print base64_encode($userid.';peserta/biodata.php;peserta;biodata')?>')">
                	<?php //if(!empty($id)){ ?>
                    <!--<input type="button" value="Hapus" class="button_disp" title="Sila klik untuk hapus maklumat penceramah" 
                    onClick="form_hapus('index.php?data=<?php print base64_encode($userid.';peserta/biodata.php;peserta;biodata')?>')">-->
                    <?php //} ?>
