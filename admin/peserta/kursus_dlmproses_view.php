<?
//$conn->debug=true;
$sSQL="SELECT B.startdate, B.enddate, C.coursename, C.courseid, A.*, C.subcategory_code 
FROM _tbl_kursus_jadual_peserta A, _tbl_kursus_jadual B, _tbl_kursus C 
WHERE A.EventId=B.id AND B.courseid=C.id AND A.InternalStudentAccepted IS NULL AND A.peserta_icno=".tosql($f_peserta_noic,"Text");
                        ...
                        <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="center"><?
								if($rs->fields['is_selected']=='1'){ 
									if(empty($rs->fields['InternalStudentAccepted'])){ print 'Tiada pengesahan'; }
...
if($cnt<>0){
	...
	//sinclude_once 'include/list_footer.php'; 
}
?> 
</td></tr>
<tr><td>        
