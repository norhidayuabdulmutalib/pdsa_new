...
$sSQL="SELECT DISTINCT B.startdate, B.enddate, B.id, A.*  
FROM _tbl_kursus_jadual_peserta A, _tbl_kursus_jadual B, _tbl_set_penilaian_peserta D 
WHERE A.EventId=B.id AND A.is_selected IN (1) AND A.peserta_icno=".tosql($_SESSION["s_logid"],"Text");
            ...
            <table width="100%" border="1" cellpadding="4" cellspacing="0">
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
						...
						//, C.coursename, C.courseid, C.SubCategoryCd, C.subcategory_code
						$rsid=$rs->fields['courseid'];
						$sqlk = "SELECT * FROM _tbl_kursus WHERE id='{$rsid}'";
						$rsk = $conn->query($sqlk);
						...
						$unit = dlookup("_tbl_kursus_catsub","SubCategoryNm","id=".tosql($rsk->fields['subcategory_code'],"Text"));
                        ...
                        <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><?php echo stripslashes($rsk->fields['courseid']);?>&nbsp;</td>
            				<td valign="top" align="left"><?php echo stripslashes($rsk->fields['coursename']);?>&nbsp;</td>
