...
<form name="ilim" method="post">
	<div class="card">
        <div class="card-header" >
            <h4>MAKLUMAT BILIK ASRAMA/PENGINAPAN</h4>
        </div>
        <div class="card-body">
			<div>
				<div colspan="3" class="title">A.&nbsp;&nbsp;&nbsp;MAKLUMAT BILIK</div>
			</div>
			<br>
			<div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><b>No Bilik :</b></label>
                <div class="col-sm-12 col-md-7">
					<input name="no_bilik" class="form-control" type="text" id="no_bilik" value="<? print $rs->fields['no_bilik'];?>" size="20" />
				</div>
			</div>

			<div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><b>Blok :</b></label>
                <div class="col-sm-12 col-md-7">
			...
			<div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><b>Aras :</b></label>
                <div class="col-sm-12 col-md-7">
			...
			<div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><b>Jenis Bilik :</b></label>
                <div class="col-sm-12 col-md-7">
			...
			<div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><b>Keadaan Bilik :</b></label>
                <div class="col-sm-12 col-md-7">
			...
			<div align="center">
				<div>
					<?php //if( $bil_penghuni == 0){ ?>
					<input type="button" value="Simpan" class="btn btn-warning" title="Sila klik untuk menyimpan maklumat" 
					onClick="form_hantar('modal_form.php?<? print $URLs;?>&pro=SAVE')">
					<? //} ?>
					<?php if( $bil_penghuni == 0 && !empty($id)) {?>
					<input type="button" value="Hapus"  name="hapus" id="hapus" class="btn btn-danger" title="Sila klik untuk menghapus maklumat" 
					onClick="form_delete('modal_form.php?<? print $URLs;?>&pro=DELETE')">
					<?php } ?>
					<input type="button" value="Kembali" class="btn btn-secondary" title="Sila klik untuk kembali ke senarai maklumat bilik" 
					onClick="do_back('');">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
						<div>
							<div colspan="3" class="title">B.&nbsp;&nbsp;&nbsp;MAKLUMAT PENGHUNI</div>
						</div>
						...
						<table class="table table-bordered">
							<thead>
								...
								//$conn->debug=true;
									...
									<tr> 
										...
										<th width="40%" align="center"><b>Nama Peserta / Penceramah<br /><i>[ Agensi ]</i></b></th>
										<th width="40%" align="center"><b>Kursus<br /><i>[ Tarikh Kursus ]</i></b></th>
										<th width="40%" align="center"><b>Tindakan</b></th>
									</tr>
							</thead>
								<?php
								if(!$rs2->EOF) {
							...
							<tbody>
								<tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
									...
									<td align="left" valign="top"><? echo stripslashes($nama_peserta);?>
									<br /><i>[ <? echo stripslashes($agensi);?> ]</i>&nbsp;</td>
									<td align="center"><? echo $kursus;?><br />
