            ...
            <li class="nav-item dropdown <?php if($menus==$rs_menu->fields['grp_kod']){ print ' active';}?>">
                ...
                <ul class="dropdown-menu">
                    ...
                    ?>
                            ...
                            <li <?php if($pages == $glink){ print ' active';}?>>
                                <a class="nav-link" href="index.php?data=<?php print base64_encode($urls);?>">
                                    <i class="fas fa-pencil-alt"></i><?php print $rs_menud->fields['menu_name'];?>
                                </a>
                            </li>
