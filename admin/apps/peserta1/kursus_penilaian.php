...
WHERE A.EventId=B.id AND B.courseid=C.id  AND A.is_selected IN (1) AND A.peserta_icno=".tosql($_SESSION["s_logid"],"Text");
...
$href_search = "index.php?data=".base64_encode($userid.';apps/peserta/kursus_penilaian.php;peserta;penilaian');
?>
