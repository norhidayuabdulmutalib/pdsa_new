...
<?php include_once 'include/page_list.php'; ?>
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<?php $new_page = "index.php?data=".base64_encode($userid.';apps/peserta/peserta_form.php;peserta;peserta;');?>
            ...
            <table width="100%" border="1" cellpadding="5" cellspacing="0">
                ...
                if(!$rs->EOF) {
                    ...
                    //while(!$rs->EOF) {
						...
						$href_link = "index.php?data=".base64_encode($userid.';apps/peserta/peserta_form.php;peserta;peserta;'.$rs->fields['id_peserta']);
