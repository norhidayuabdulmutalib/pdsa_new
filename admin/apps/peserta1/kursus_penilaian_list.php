...
$sql1 = "SELECT * FROM _tbl_set_penilaian_peserta_bhg WHERE event_id=".tosql($kursus_id)." AND fset_id=".tosql($fset_id)." AND id_peserta=".tosql($id);
$rs_sql1 = &$conn->Execute($sql1);
if($rs_sql1->EOF){
