...
$href_search = "index.php?data=".base64_encode($userid.';apps/asrama/dmasuk_list.php;asrama;masuk');
?>
...
<ul class="menu5">
    <li <?php if($sub_tab=='peserta'){ print 'class="current"'; }?>>
        <a href="index.php?data=<?php print base64_encode($userid.';apps/asrama/dmasuk_list.php;asrama;masuk;'.$id.';peserta');?>" style="cursor:pointer">
        <b>Senarai Penserta Kursus <i>(<?php print $cnt_peserta;?> orang)</i> </b></a></li>
    <li <?php if($sub_tab=='penceramah'){ print 'class="current"'; }?>>
        <a href="index.php?data=<?php print base64_encode($userid.';apps/asrama/dmasuk_list.php;asrama;masuk;'.$id.';penceramah');?>" style="cursor:pointer">
    ...
    <tr> 
      <td width="75%" colspan="5"> <table border="1" width=100% cellspacing="0" cellpadding="5" bordercolorlight="#000000" bordercolordark="#FFFFFF">
        ...
        if(!$rs->EOF) {
            ...
            $bil = $StartRec;
            while(!$rs->EOF  && $cnt <= $pg) {
                //$href_link = "index.php?data=".base64_encode($userid.';apps/asrama/dmasuk_form.php;asrama;masuk;'.$rs->fields['daftar_id']);
          ...
          <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            ...
            <td valign="top"><a onclick="open_modal('<?=$href_link;?>&tab=<?=$sub_tab;?>','Daftar Masuk Penghuni Asrama',700,350)" style="cursor:pointer">
            	...
            	<br /><i>[<?php echo stripslashes($rs->fields['NOKP']);?>]</i><br /><?php echo stripslashes($rs->fields['agensi']);?>&nbsp;</td>
            <td align="center"><?php echo stripslashes($rs->fields['coursename']);?>&nbsp;</td>
            <td align="center"><?php echo DisplayDate($rs->fields['startdate']);?><br>-<br><?php echo DisplayDate($rs->fields['enddate']);?></td>
            <td align="center">
