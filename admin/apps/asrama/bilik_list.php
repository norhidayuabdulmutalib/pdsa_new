...
if(!empty($href_directory)){
	$href_search = "index.php?data=".base64_encode($userid.';apps/asrama/menu_asrama.php;asrama;bilik;;../apps/asrama/bilik_list.php');
} else {
	$href_search = "index.php?data=".base64_encode($userid.';apps/asrama/bilik_list.php;asrama;bilik');
} 
?>
