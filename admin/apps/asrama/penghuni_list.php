...
$href_search = "index.php?data=".base64_encode($userid.';apps/asrama/penghuni_list.php;asrama;penghuni');
?>
...
?>
<ul class="menu5">
    <li <?php if($sub_tab=='peserta'){ print 'class="current"'; }?>>
        <a href="index.php?data=<?php print base64_encode($userid.';apps/asrama/penghuni_list.php;asrama;penghuni;'.$id.';peserta');?>">
        <b>Senarai Penserta Kursus <i>(<?php print $cnt_peserta;?> orang)</i> </b></a></li>
    <li <?php if($sub_tab=='penceramah'){ print 'class="current"'; }?>>
        <a href="index.php?data=<?php print base64_encode($userid.';apps/asrama/penghuni_list.php;asrama;penghuni;'.$id.';penceramah');?>">
    ...
    <tr> 
      <td width="75%" colspan="5"> <table border="1" width=100% cellspacing="0" cellpadding="5" bordercolorlight="#000000" bordercolordark="#FFFFFF">
        ...
        if(!$rs->EOF) {
            ...
            $bil = $StartRec;
            while(!$rs->EOF  && $cnt <= $pg) {
                //$href_link = "index.php?data=".base64_encode($userid.';apps/asrama/penghuni_form.php;asrama;penghuni;'.$rs->fields['daftar_id']);
          ...
          <tr bgcolor="<?php print $bg; ?>">
            <td align="right" valign="top"><?php echo $bil;?>.&nbsp;<?//=$sub_tab;?></td>
            <td valign="top"><a onclick="open_modal('<?=$href_link;?>&tab=<?=$sub_tab;?>','Daftar Keluar Penghuni Asrama',700,350)" style="cursor:pointer"> 
				<?php echo stripslashes($nama_peserta);?></a>
            	<br /><i>[<?php echo stripslashes($rs->fields['NOKP']);?>]</i>&nbsp;</td>
            <td align="center" valign="top"><?php echo stripslashes($agensi);?>&nbsp;</td>
            <td align="center" valign="top"><?php echo $kursus;?><br />
            <i>[<?php echo DisplayDate($rs_kursus->fields['mula']);?> - <?php echo DisplayDate($rs_kursus->fields['tamat']);?>]</i>&nbsp;</td>
            <td align="center"><?php echo dlookup("_sis_a_tblbilik", "no_bilik", "bilik_id = '".stripslashes($rs->fields['bilik_id'])."'");?>&nbsp;</td>
            <td align="center">
