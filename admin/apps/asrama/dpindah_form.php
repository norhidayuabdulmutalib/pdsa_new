...
<table width="100%" align="center" cellpadding="3" cellspacing="1" border="0">
   ...
   <tr>
    ...
    <?php $sql_l = "SELECT * FROM _ref_blok_bangunan WHERE f_kb_id=2 AND f_bb_status = 0 AND is_deleted=0 ORDER BY f_bb_desc";
   ...
   <tr>
    ...
    <?php  $sql_l = "SELECT * FROM _sis_a_tblbilik  WHERE status_bilik = 0 AND keadaan_bilik = 1 AND is_deleted = 0 AND blok_id=".tosql($blok_search,"Number")." ORDER BY no_bilik";
        $rs_l = $conn->Execute($sql_l); 
        //echo $sql_l;
    ?>
   <tr>
...
<table width="100%" align="center" cellpadding="5" cellspacing="1" border="0">
   ...
   <tr>
    ...
    <?php $sql_l = "SELECT A.*, B.no_bilik, B.tingkat_id, C.f_bb_desc FROM _sis_a_tblasrama A, _sis_a_tblbilik B, _ref_blok_bangunan C
