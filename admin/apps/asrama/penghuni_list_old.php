        ...
        if(!$rs->EOF) {
          ...
          <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            ...
            <td valign="top"><a onclick="open_modal('<?=$href_link;?>&tab=<?=$sub_tab;?>','Daftar Keluar Penghuni Hostel',700,350)" style="cursor:pointer"> 
				<?php echo stripslashes($rs->fields['daftar_nama']);?></a>
            	<br /><i>[<?php echo stripslashes($rs->fields['NOKP']);?>]</i>&nbsp;</td>
            <td align="center" valign="top"><?php echo stripslashes($rs->fields['agensi']);?>&nbsp;</td>
            <td align="center" valign="top"><?php echo $rs_kursus->fields['kursus'];?><br />
