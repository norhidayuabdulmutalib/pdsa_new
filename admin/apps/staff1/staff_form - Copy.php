	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <td width="50%" colspan="2">
                    <select name="f_jabatan">
                        ...
                        <option value="<?=$rsgred->fields['jabatan_id'];?>" <?php if($rs->fields['f_jabatan']==$rsgred->fields['jabatan_id']){ print 'selected'; }
            ...
            <tr>
                ...
                <td>
                	<select name="f_level">
                    	<option value="1" <?php if($rs->fields['f_level']=='1'){ print 'selected';} ?>>Administrator Sistem</option>
