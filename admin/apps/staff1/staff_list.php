...
$href_search = "index.php?data=".base64_encode($userid.';apps/staff/staff_list.php;admin;staff');
?>
...
<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<?php $new_page = "index.php?data=".base64_encode($userid.';apps/staff/staff_form.php;admin;staff;');?>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                ...
                if(!$rs->EOF) {
                    ...
                    //while(!$rs->EOF) {
						...
						$href_link = "index.php?data=".base64_encode($userid.';apps/staff/staff_form.php;admin;staff;'.$rs->fields['id_user']);
