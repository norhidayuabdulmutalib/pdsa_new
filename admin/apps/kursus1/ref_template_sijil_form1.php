...
if(!empty($proses)){ 
	...
	if(empty($id)){
		$sql = "INSERT INTO _ref_template_sijil(kampus_id, ref_tajuk_sijil, ref_ts_head1, ref_ts_head1_font, 
			...
			ref_ts_status, tarikh_hijrah, ref_ts_oleh, ref_ts_jawatan) 
		...
		".tosql(strtoupper($ref_ts_head2),"Text").", ".tosql($ref_ts_head2_font,"Text").", ".tosql($ref_ts_head2_size,"Text").", ".tosql($ref_ts_head2_fontstyle,"Text").", 
		".tosql(strtoupper($ref_ts_head3),"Text").", ".tosql($ref_ts_head3_font,"Text").", ".tosql($ref_ts_head3_size,"Text").", ".tosql($ref_ts_head3_fontstyle,"Text").", 
		...
		".tosql($ref_ts_status,"Text").", ".tosql($tarikh_hijrah,"Text").", ".tosql($ref_ts_oleh,"Text").", ".tosql($ref_ts_jawatan,"Text").")";
		$rs = &$conn->Execute($sql);
	} else {
		$sql = "UPDATE _ref_template_sijil SET kampus_id=".tosql($kampus_id).", 
			...
			ref_ts_oleh=".tosql($ref_ts_oleh).", ref_ts_jawatan=".tosql($ref_ts_jawatan)." 
    ...
    <tr>
        ...
        <div style="float:right">
            ...
            <?php if(empty($forms)){ ?>
    	    	...
    	    	<input type="button" value="HAPUS" class="button_disp" title="Sila klik untuk menghapuskan maklumat" onClick="form_hantar('modal_form.php?<?php print $URLs;?>&pro=DEL')" >
                <?php } ?>
            <?php } else { ?>
        	...
        	<tr>
            	<td width="50%" align="center" valign="top">
                	<table width="100%" cellpadding="5" cellspacing="1" border="1" align="center">
                        ...
                        <tr>
			                <td align="center" height="150px"><b>(<?php print $rs->fields['ref_ts_oleh'];?>)</b><br />Pengarah<br />Institut Latihan Islam Malaysia<br />Jabatan Kemajuan Islam Malaysia</td>
                        </tr>
                    </table>
                </td>
                <td width="50%" align="center" valign="top">
                	<table width="100%" cellpadding="5" cellspacing="1" border="0" align="center">
                        ...
                        <tr>
                            ...
                            style="text-align:center;background-color:#CCCCCC" />
                            <br />Institut Latihan Islam Malaysia<br />Jabatan Kemajuan Islam Malaysia</td>
                        </tr>
                    </table>
                </td>
            </tr>
