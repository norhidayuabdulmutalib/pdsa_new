...
$cnt = $rs->recordcount();
$conn->debug=false;
$href_search = "index.php?data=".base64_encode($userid.';apps/kursus/kursus_mohon_list.php;kursus;peserta');
?>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
						...
						<tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
							...
							<td valign="top" align="left"><?php echo dlookup("_tbl_kursus_cat","categorytype",
