...
$href_search = "index.php?data=".base64_encode($userid.';apps/kursus/jadual_kursus.php;kursus;jkursus');
?>
        ...
        <td colspan="5" align="center">
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                <tr bgcolor="#CCCCCC">
                    ...
                    <a href="<?php echo $href_search."../kursus/&sb=coursename&search=$search&tkh_mula=$tkh_mula&tkh_tamat=$tkh_tamat"; ?>"><b>Diskripsi Kursus</b></a>&nbsp;
