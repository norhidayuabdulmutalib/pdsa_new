...
if(!empty($href_directory)){
	$href_search = "index.php?data=".base64_encode($userid.';apps/asrama/menu_asrama.php;asrama;bkuliah;;../apps/maintenance/bilik_kuliah_list.php');
} else {
	$href_search = "index.php?data=".base64_encode($userid.';apps/maintenance/bilik_kuliah_list.php;admin;bkuliah');
} 
?>
