...
$href_search = "index.php?data=".base64_encode($userid.';apps/maintenance/logmasuk_list.php;admin;logmasuk');
?>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
            				...
            				<td valign="top" align="left"><?php echo stripslashes($rs->fields['log_user']);?>&nbsp;</td>
            				<td valign="top" align="left"><?php echo stripslashes($rs->fields['trans_date']);?>&nbsp;</td>
