...
if(!empty($href_directory)){
	$href_search = "index.php?data=".base64_encode($userid.';apps/asrama/menu_asrama.php;asrama;aras_bangunan;;../apps/maintenance/aras_bangunan_list.php');
} else {
	$href_search = "index.php?data=".base64_encode($userid.';apps/maintenance/aras_bangunan_list.php;admin;aras_bangunan');
} 
?>
