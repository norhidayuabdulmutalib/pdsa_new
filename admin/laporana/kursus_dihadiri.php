...
<table width="<?=$width?>" border="0" align="center" cellpadding="1" cellspacing="0">
    ...
    <tr><td colspan="1" align="right">Tempat Bertugas : </td>
    	<td>
    	<select name="pusat" style="cursor:pointer" title="Sila pilih maklumat untuk carian" onChange="do_pages('<?=$href_search?>')">
    ...
    <tr><td colspan="1" align="right">Jawatan : </td>
    	<td>
        <select name="grade" style="cursor:pointer" onChange="do_pages('<?=$href_search?>')">
        	<option value=""> -- Sila pilih -- </option>
            <?php while(!$rspg->EOF){ ?>
