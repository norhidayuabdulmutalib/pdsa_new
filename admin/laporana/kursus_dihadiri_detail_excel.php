...
header("Content-Disposition: attachment; filename=kursus_dihadir_detail.xls");
...
<table width="<?=$width?>" border="0" align="center" cellpadding="4" cellspacing="0" class="data" >
    <tr><td colspan="2" width="30%" align="right"><b>Nama Pegawai : </b></td>
    <td width="70%" align="left" colspan="3"><?php print $rs->fields['f_peserta_nama'];?></td></tr>
    <tr><td colspan="2" align="right"><b>No KP : </b></td>
    <td align="left" colspan="3"><?php print $rs->fields['f_peserta_noic'];?>&nbsp;</td></tr>
    <tr><td colspan="2" align="right"><b>Jawatan : </b></td>
    <td align="left" colspan="3"><?php print dlookup2("_ref_titlegred","f_gred_code","f_gred_name","f_gred_id=".tosql($rs->fields['f_title_grade']));?></td></tr>
    <tr><td colspan="2" align="right"><b>Ttempat Bertugas : </b></td>
    <td align="left" colspan="3"><?php print dlookup("_ref_tempatbertugas","f_tempat_nama","f_tbcode=".tosql($rs->fields['BranchCd']));?></td></tr>
</table>
<br>
...
WHERE A.EventId=B.id AND B.courseid=C.id AND A.is_sijil=1 AND A.peserta_icno=".tosql($ic);
