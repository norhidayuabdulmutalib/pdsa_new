	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="1" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" size="65" name="fld_staff" value="<?php print $rs->fields['fld_staff'];?>" /></td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" name="fld_kp"  value="<?php print $rs->fields['fld_kp'];?>" /></td>
            </tr>
            <tr>
                <td valign="top">Alamat Surat-menyurat : </td>
                <td colspan="2"><textarea cols="60" rows="4" name="fld_alamat"><?php print $rs->fields['fld_alamat'];?></textarea></td>
            </tr>
            <!--<tr>
              <td>Poskod : </td>
              <td colspan="3"><input type="text" name="new_pass" size="5" maxlength="5" value="<?php print $rs->fields['fld_staff'];?>"></td>
            </tr>-->
            <tr>
                <td width="20%">No. Telefon : </td>
                <td width="50%" colspan="2"><input type="text" name="fld_tel" size="20" maxlength="15" value="<?php print $rs->fields['fld_tel'];?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" name="fld_email"  size="65" value="<?php print $rs->fields['fld_email'];?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <select name="pusatid">
                        <?php while(!$rspusat->EOF) { ?>
                        <option value="<?=$rspusat->fields['pusat_id'];?>" <?php if($rs->fields['fldpusat']==$rspusat->fields['pusat_id']){ print 'selected'; }?>>[<?=$rspusat->fields['pusat_no'];?>]&nbsp;&nbsp;<?=$rspusat->fields['pusat_nama'];?></option>
                        <?php $rspusat->MoveNext(); } ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                	<input type="checkbox" name="is_pensyarah" value="Y" <?php if($rs->fields['is_pensyarah']=='Y'){ print 'checked';} ?> />&nbsp;&nbsp;Pensyarah<br />
                	<input type="checkbox" name="is_tutor" value="Y" <?php if($rs->fields['is_tutor']=='Y'){ print 'checked';} ?> />&nbsp;&nbsp;Tutor<br />
                	<input type="checkbox" name="is_warden" value="Y" <?php if($rs->fields['is_warden']=='Y'){ print 'checked';} ?> />&nbsp;&nbsp;Penyelia Asrama<br />
                	<input type="checkbox" name="is_hep" value="Y" <?php if($rs->fields['is_hep']=='Y'){ print 'checked';} ?> />&nbsp;&nbsp;Pegawai HEP<br />
                </td>
            </tr>
            <tr>
                <td valign="top" height="25">ID pengguna : </td>
                <td colspan="3"><b><?php print $rs->fields['flduser_name'];?></b>
                <input type="hidden" name="user_name" value="<?php print $rs->fields['flduser_name'];?>"  />
                </td>
            </tr>
            <tr>
                <td>Status : </td>
                <td>
                	<select name="flduser_activated">
                    	<option value="1" <?php if($rs->fields['flduser_activated']=='1'){ print 'selected';} ?>>Aktif</option>
                        <option value="0" <?php if($rs->fields['flduser_activated']=='0'){ print 'selected';} ?>>Tidak Aktif</option>
                    </select>
                </td>
                <td>Pengguna Sistem : </td>
                <td>
                	<select name="is_user">
                    	<option value="1" <?php if($rs->fields['is_user']=='1'){ print 'selected';} ?>>Ya</option>
                    	<option value="0" <?php if($rs->fields['is_user']=='0'){ print 'selected';} ?>>Tidak</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3"><br>
                    ...
                    onClick="form_hantar('index.php?data=<?php print base64_encode($userid.';apps/staff/user_form_do.php;admin;user;')?>')">
                	<input type="button" value="Kembali" class="button_disp" title="Sila klik untuk kembali ke senarai pengguna sistem" 
                    onClick="do_back('index.php?data=<?php print base64_encode($userid.';apps/staff/user_list.php;admin;user;');?>')">
