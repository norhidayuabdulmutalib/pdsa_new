...
if(!empty($id)){
	$sSQL="SELECT * FROM _tbl_penilaian_set WHERE pset_id = ".tosql($id,"Text");
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
    <tr>
    	<td colspan="2" class="title" height="25">SELENGGARA MAKLUMAT SET PENILAIAN KURSUS</td>
    </tr>
	<tr><td colspan="2">
    	<table width="80%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    onClick="form_hantar('index.php?data=<?php print base64_encode($userid.';apps/penilaian_set/set_penilaian_kursus.php;nilai;set_nilai;');?>')" >
   ...
   <?php if(!empty($id)){ 
   $href_link = "modal_form.php?win=".base64_encode('penilaian_set/set_pilih.php;')."&id=".$id;?>
   <tr><td colspan="2" width="80%">&nbsp;</td></tr>
   <tr><td colspan="2" align="center">
   		<?php include 'set_penilaian_kursus_list.php';?>
   </td></tr>
   <?php } ?>
</table>
</form>
