...
$href_search = "index.php?data=".base64_encode($userid.';penilaian_set/set_penilaian_kursus.php;nilai;set_nilai');
?>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        ...
        <td colspan="2" valign="middle" align="right">
        	<?php $new_page = "index.php?data=".base64_encode($userid.';penilaian_set/set_penilaian_kursus_form.php;nilai;set_nilai');?>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#000000">
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                		...
                		$href_link = "index.php?data=".base64_encode($userid.';penilaian_set/set_penilaian_kursus_form.php;nilai;set_nilai;'.$rs->fields['pset_id']);
                        ?>
