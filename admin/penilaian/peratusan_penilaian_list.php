...
<table width="98%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="1">
      <tr>
        <td width="14%">1. Umur :</td>
        <td width="10%">20 ke bawah</td>
        <td width="20%">
        	...
        	<input type="text" size="2" name="fset_umur19" value="<?php print $u19;?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="umur_19" value="<?php print $rs_nilai->fields['fset_umur19_off']+$u19;?>" style="text-align:center" disabled="disabled"/>
            (<input type="text" size="3" name="umur_all" value="<?php print $jum_all_umur;?>" style="text-align:center" disabled="disabled"/>)        
        </td>
        <td width="2%">&nbsp;</td>
        <td width="15%">2. Jantina :</td>
        ...
        <td width="20%">
        	...
        	<input type="text" size="2" name="fset_jantina_l" value="<?php print $rs_nilai->fields['fset_jantina_l'];?>" 
            	style="text-align:center" disabled="disabled"/>
			= <input type="text" size="2" name="jantina_l" 
            	value="<?php print $rs_nilai->fields['fset_jantina_l_off']+$jum_l;?>" 
            	style="text-align:center" disabled="disabled"/>
			 (<input type="text" size="2" name="umur_all2" 
             	value="<?php print $rs_nilai->fields['fset_jantina_l_off']+$jum_l+
			 $rs_nilai->fields['fset_jantina_p_off']+$jum_p;?>" style="text-align:center" disabled="disabled"/>) 
         </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_umur20" value="<?php print $u20;?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="2" name="umur_20" value="<?php print $rs_nilai->fields['fset_umur20_off']+$u20;?>" style="text-align:center" disabled="disabled"/>        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>Perempuan</td>
        <td>
        	...
        	<input type="text" size="2" name="fset_jantina_p" value="<?php print $jum_p;?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="2" name="jantina_p" value="<?php print $rs_nilai->fields['fset_jantina_p_off']+$jum_p;?>" readonly="readonly"style="text-align:center" disabled="disabled"/>        
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_umur30" value="<?php print $u30;?>" style="text-align:center" disabled="disabled"/>
			= <input type="text" size="2" name="umur30" value="<?php print $rs_nilai->fields['fset_umur30_off']+$u30;?>" style="text-align:center" disabled="disabled" />        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_umur40" value="<?php print $u40;?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="umur_40" value="<?php print $rs_nilai->fields['fset_umur40_off']+$u40;?>" style="text-align:center" disabled="disabled"/>        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_umur50" value="<?php print $u50;?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="umur_50" value="<?php print $rs_nilai->fields['fset_umur50_off']+$u50;?>" style="text-align:center" disabled="disabled"/> 
			</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>
			...
			= <input type="text" size="2" name="jusa" value="<?php print $rs_nilai->fields['fset_jusa_off']+$kum_j;?>" style="text-align:center" disabled="disabled"/>
			 (<input type="text" size="3" name="umur_all4" value="<?php print $rs_nilai->fields['fset_jusa_off']+$kum_j+$rs_nilai->fields['fset_pp_off']+$kum_p+$rs_nilai->fields['fset_sokongan_off']+$kum_s;?>" style="text-align:center" disabled="disabled"/>)        
        </td>
        <td>&nbsp;</td>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_pertama" value="<?php print $train_1;?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="pertama" value="<?php print $rs_nilai->fields['fset_pertama_off']+$train_1;?>" style="text-align:center" disabled="disabled" />
			 (<input type="text" size="3" name="umur_all3" value="<?php print $rs_nilai->fields['fset_pertama_off']+$train_1+$rs_nilai->fields['fset_kedua_off']+$train_2+$rs_nilai->fields['fset_ketiga_off']+$train_3;?>" style="text-align:center" disabled="disabled"/>)        
         </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_pp" value="<?php print number_format($kum_p,0);?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="pp" value="<?php print $rs_nilai->fields['fset_pp_off']+$kum_p;?>" style="text-align:center" disabled="disabled" />        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>Kedua</td>
        <td>
        	...
        	<input type="text" size="2" name="fset_kedua" value="<?php print $train_2;?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="kedua" value="<?php print $rs_nilai->fields['fset_kedua_off']+$train_2;?>" style="text-align:center" disabled="disabled" />        
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_sokongan" value="<?php print number_format($kum_s,0);?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="sokongan" value="<?php print $rs_nilai->fields['fset_sokongan_off']+$kum_s;?>" style="text-align:center" disabled="disabled" />        
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td>
        	...
        	<input type="text" size="2" name="fset_ketiga" value="<?php print $train_3;?>" style="text-align:center" disabled="disabled" />
			= <input type="text" size="2" name="ketiga" value="<?php print $rs_nilai->fields['fset_ketiga_off']+$train_3;?>" style="text-align:center" disabled="disabled" />        
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=1 
        AND A.InternalStudentAccepted=1 AND is_selected IN (1) AND B.is_deleted=0 AND A.EventId=".tosql($id);
        $sqlj .= " AND A.is_deleted=0 GROUP BY A.peserta_icno";
        //print $sqlj; //AND A.is_sijil=1 
        $rsj = $conn->query($sqlj); $jakim = $rsj->recordcount();
		if(!empty($jakim)){  $bil++; ?> 
        <tr>
        	<td align="right"><?=$bil;?>.</td>	
            <td>Jabatan Kemajuan Islam Malaysia (JAKIM)</td>
            <td align="center"><?php print $jakim; $jum_all+=$jakim; ?></td>
        </tr>    
        <?php } ?>
		<?php
        $sqlj = "SELECT * FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
        WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid=2 
        AND  A.InternalStudentAccepted=1 AND is_selected IN (1) AND B.is_deleted=0 AND A.EventId=".tosql($id);
        //AND  A.InternalStudentAccepted=1 AND is_selected IN (1) AND B.is_deleted=0 AND A.EventId=".tosql($id);
        $sqlj .= " AND A.is_deleted=0 GROUP BY A.peserta_icno";
        //print $sqlj; // A.is_sijil=1 AND
        $rsj = $conn->query($sqlj); $jain = $rsj->recordcount(); 
        if(!empty($jain)){  $bil++; ?>
        <tr>
        	<td align="right"><?=$bil;?>.</td>	
            <td>Jabatan Agama Islam Negeri (JAIN)</td>
            <td align="center"><?php print $jain; $jum_all+=$jain; ?></td>
        </tr>    
        <?php } ?>
		<?php
        $sqlj = "SELECT * FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
        WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid 
        AND D.ref_ktid=3 AND A.InternalStudentAccepted=1 
        AND is_selected IN (1) AND B.is_deleted=0 AND A.EventId=".tosql($id);
        $sqlj .= " GROUP BY A.peserta_icno";
        $rsj = $conn->query($sqlj); $main = $rsj->recordcount();		//AND A.is_sijil=1 
        if(!empty($main)){  $bil++; ?>
        <tr>
        	<td align="right"><?=$bil;?>.</td>	
            <td>Majlis Agama Islam Negeri (MAIN)</td>
            <td align="center"><?php print $main; $jum_all+=$main; ?></td>
        </tr>    
        <?php } ?>
		<?php
        $sqlj = "SELECT * FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
        WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid 
		AND D.ref_ktid=4 AND A.InternalStudentAccepted=1 
        AND is_selected IN (1) AND B.is_deleted=0 AND A.EventId=".tosql($id);
        $sqlj .= " GROUP BY A.peserta_icno";
        $rsj = $conn->query($sqlj); $jmufti = $rsj->recordcount();  //AND A.is_sijil=1 
        if(!empty($jmufti)){  $bil++; ?>
        <tr>
        	<td align="right"><?=$bil;?>.</td>	
            <td>Jabatan Mufti</td>
            <td align="center"><?php print $jmufti; $jum_all+=$jmufti; ?></td>
        </tr> 
        <?php } ?>
        <?php
		$cnts=$bil+1;
        $sqljlain = "SELECT distinct B.BranchCd 
			FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_tempatbertugas C, _ref_tempat_kategori D
			WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid AND D.ref_ktid>=5 
			AND A.InternalStudentAccepted=1 AND is_selected IN (1) AND A.is_deleted=0 AND B.is_deleted=0 AND A.EventId=".tosql($id);
		$sqljlain .= " GROUP BY A.peserta_icno";
		$rsjlain = $conn->query($sqljlain); //AND A.is_sijil=1 
		//print $sqljlain;
		while(!$rsjlain->EOF){ 
		?>
        <tr>
            ...
            <td align="center"><?php
				...
				WHERE A.peserta_icno=B.f_peserta_noic AND B.BranchCd=C.f_tbcode AND C.ref_ktid=D.ref_ktid 
				AND A.InternalStudentAccepted=1 AND D.ref_ktid>=5  AND A.is_deleted=0
				AND is_selected IN (1) AND B.is_deleted=0 AND A.EventId=".tosql($id)." AND B.BranchCd=".$rsjlain->fields['BranchCd']; //AND A.is_sijil=1
				$sqljlain .= " GROUP BY peserta_icno";
				//if($rsjlain->fields['BranchCd']=='0101'){ print $sqljlain; } 
				$rsjl = $conn->query($sqljlain); print $rsjl->recordcount(); $jum_all+=$rsjl->recordcount();
            ?></td>
        </tr>    
        ...
        <tr>
			...
			AND is_selected IN (1) AND A.EventId=".tosql($id);
			$sqlj .= " GROUP BY peserta_icno";
			//print $sqlj;
			$rsj = $conn->query($sqlj); $ll = $rsj->recordcount(); print $ll; $jum_all+=$ll; //AND A.is_sijil=1 
			$conn->debug=false;
			?></td>
        </tr> 
        <tr>
      ...
      <tr>
		...
		<table width="100%" border="1" cellpadding="5" cellspacing="0">
			...
			$rsgred = $conn->query($sql1);
            while(!$rsgred->EOF){*/ 

				$sqljlain = "SELECT count(*) as grades, A.peserta_icno, B.f_title_grade, C.f_gred_name, C.f_gred_code
					FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B, _ref_titlegred C
					WHERE A.peserta_icno=B.f_peserta_noic AND  B.f_title_grade=C.f_gred_id 
					AND A.InternalStudentAccepted=1 AND A.is_selected IN (1) AND B.is_deleted=0 AND A.is_deleted=0 
					AND A.EventId=".tosql($id)." GROUP BY B.f_title_grade";
				$rsjlain = $conn->query($sqljlain);  $cnt=0;
				//print $sqljlain."<br>"; 
				$bil=0;
				while(!$rsjlain->EOF){  $bil++;
					$kodgred = $rsjlain->fields['f_gred_name'] . " &nbsp;(".$rsjlain->fields['f_gred_code'].")";
					$grades = $rsjlain->fields['grades']; $cnt_jum+=$rsjlain->fields['grades']; //=$grades;
				?>
				<tr>
            ...
            <table width="100%" border="1" cellpadding="5" cellspacing="0">
				...
				while(!$rsgred->EOF){ //$cntn++;
					...
					$sqljlain = "SELECT count(*) as negeris, B.f_peserta_negeri FROM _tbl_kursus_jadual_peserta A, _tbl_peserta B
								WHERE A.peserta_icno=B.f_peserta_noic AND A.InternalStudentAccepted=1 AND A.is_selected IN (1) 
								AND A.EventId=".tosql($id)." AND B.f_peserta_negeri=".tosql($rsgred->fields['kod_negeri'])." 
								AND A.is_deleted=0 AND B.is_deleted=0 GROUP BY A.peserta_icno";
					//print $sqljlain;
					$rsjlain = $conn->query($sqljlain); $tot_neg=0;
	...
	$rs_bhg = $conn->query($sql_det);
            ...
            ?>
                    ...
                    if(!empty($fsetb_pensyarah_id)){ // JIKA MELIBATKAN PENSYARAH
						...
						FROM _tbl_kursus_jadual_masa A, _tbl_instructor B WHERE A.event_id=".tosql($id)." 
						AND A.id_pensyarah=".tosql($fsetb_pensyarah_id)." AND A.id_pensyarah=B.ingenid 
						AND A.id_jadmasa=".tosql($fsetb_jadmasaid);
						$sql_p .= " ORDER BY A.tarikh, A.masa_mula";
                        $rs_pensyarah = $conn->query($sql_p);
						//print $sql_p;
					...
					$sql_det = "SELECT A.*, B.f_penilaian_jawab, B.f_penilaian_desc 
					FROM _tbl_set_penilaian_bhg_detail A, _ref_penilaian_maklumat B 
