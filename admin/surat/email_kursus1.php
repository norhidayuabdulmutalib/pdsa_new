...
$kandungan_email = "test"; //dlookup("_tbl_surat","surat","surat_jenis='P' AND peserta_icno=".tosql($f_peserta_noic,"Text"). " AND EventId=".tosql($EventId));
/* penerima */
...
$kandungan_email .= '<br><br>Sila klik <a href="http://itis.islam.gov.my/surat/borang_kehadiran.php?ic='.$f_peserta_noic.'&id='.$EventId.'">disini</a> untuk cetakan borang kehadiran.'; 
/* penerima */
/* To send HTML mail, you can set the Content-type header. */
$headers  = "MIME-Version: 1.0\r\n";
$headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
