...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
    <tr> 
        ...
        SISTEM MAKLUMAT LATIHAN JAKIM</strong></font></div>
        	...
        	<tr>
	                ...
	                <table width="98%" cellpadding="4" cellspacing="0" border="0">
    					<tr>
                        	<td width="100%">
                                ...
                                ?>
                                <marquee width="100%" height=370  scrolldelay="250" direction=up> 
                                <?php 
                                if(!$rs_marque->EOF) {
                                    while (!$rs_marque->EOF) {
                ...
                <td width="50%" align="center" valign="top" bgcolor="#CCCCCC"><b>Maklumat Kursus</b><hr />
                	<table width="98%" cellpadding="4" cellspacing="0" border="1" bgcolor="#FFFFFF">
                    	<?php //$conn->debug=true; 
							//$jum_bln_ini = dlookup("_tbl_kursus_jadual","count(*)",$sqlc); 
							//$conn->debug=true;
