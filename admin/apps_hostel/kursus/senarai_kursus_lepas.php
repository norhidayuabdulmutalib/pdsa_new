...
$href_search = "index.php?data=".base64_encode('user;asrama/menu_asrama.php;asrama;kursus;;kursus/senarai_kursus_lepas.php');
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
        ...
        <td width="20%" rowspan="4">
        	<img src="../images/btn_web-users_bg.gif" width="25" height="25" border="0" /> Paparan penghuni asrama
        </td>
	</tr>
	<tr>
...
<table width="99%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top" bgcolor="#80ABF2"> 
        <td height="30" colspan="3" valign="middle">
	        ...
	        &nbsp;&nbsp;<strong>SENARAI MAKLUMAT KURSUS YANG TELAH DIJALANKAN</strong></font>
        </td>
    </tr>
    <tr>
                ...
                if(!$rs->EOF) {
                    ...
                    while(!$rs->EOF  && $cnt <= $pg) {
                        ...
                        <tr bgcolor="<? if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            ...
                            <td align="center">
                            <?php if(empty($rs->fields['courseid'])){ $href_link = "modal_form.php?win=".base64_encode('asrama/maklumt_penghuni.php;'.$rs->fields['id']); ?>
                            	<img src="../images/btn_web-users_bg.gif" width="30" height="30" style="cursor:pointer" title="Sila klik untuk paparan senarai penghui asrama" 
                                onclick="open_modal('<?=$href_link;?>','Senarai Penghuni Asrama',1,1)" />
                            <?php } else { $href_bilik = "modal_form.php?win=".base64_encode('asrama/maklumt_penghuni.php;'.$rs->fields['id']); ?>
                            	<img src="../images/btn_web-users_bg.gif" width="30" height="30" style="cursor:pointer" title="Sila klik untuk paparan senarai penghuni asrama" 
                                onclick="open_modal('<?=$href_bilik;?>','Senarai Penghuni Asrama',1,1)" /> 
							<?php } ?>
                            </td>
                        </tr>
                        <?
