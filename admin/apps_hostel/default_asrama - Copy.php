	                ...
	                <table width="98%" cellpadding="4" cellspacing="0" border="0">
    					<tr>
                        	<td width="100%">
								...
								WHERE A.id=B.courseid AND A.is_deleted=0 AND B.enddate>=".tosql($start,"Text")." AND B.enddate<=".tosql($end,"Text");
                ...
                <td width="50%" align="center" valign="top" bgcolor="#CCCCCC"><b>Maklumat Kursus</b><hr />
                	<table width="98%" cellpadding="4" cellspacing="0" border="1" bgcolor="#FFFFFF">
                    	...
                    	<tr>
							...
							$sSQL="SELECT A.* FROM _tbl_kursus_jadual A WHERE '$this_dt' BETWEEN A.startdate AND A.enddate ORDER BY A.startdate";
