	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><?php echo $rs->fields['insid'];?></td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><?php print $rs->fields['insname'];?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="80%" colspan="3"><?php print $rs->fields['insorganization'];?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><?php print $rs->fields['inshometel'];?></td>
            </tr>
            <tr>
                <td width="20%"><b>No. Telefon Bimbit : </b></td>
                <td width="50%" colspan="2"><?php print $rs->fields['insmobiletel'];?></td>
            </tr>
            <tr>
                <td width="20%"><b>No. Faks : </b></td>
                <td width="50%" colspan="2"><?php print $rs->fields['insfaxno'];?></td>
            </tr>
            <tr>
                <td width="20%"><b>Email : </b></td>
                <td width="50%" colspan="2"><?php print $rs->fields['insemail'];?></td>
            </tr>
            <tr>
                <td valign="top"><b>Alamat : </b></td>
                <td colspan="2"><?php print stripslashes(nl2br($rs->fields['insaddress']));?></td>
            </tr>
            <tr>
                <td width="20%"><b>Jantina : </b></td>
                <td width="50%" colspan="2"><?php if($rs->fields['insgender']=='L'){ print 'Lelaki'; } else { print 'Perempuan'; }?></td>
            </tr>
            <tr>
          ...
          <tr>
			...
			<tr>
                ...
                <td colspan="2">RM <?php print $rs->fields['payperhours'];?></td>
            </tr>
            <tr>
                <td colspan="4">
                	<table width="100%" cellpadding="3" cellspacing="0" border="0">
                    	<tr class="title" >
                        	<td colspan="4">MAKLUMAT BUKU BANK</td>
						</tr>
                </table>
                <table width="100%" cellpadding="3" cellspacing="0" border="1">
                    	<tr class="title" >
                            ...
                            <td width="30%">Cawangan</td>
                            <td width="25%">No. Akaun Bank</td>
                        </tr>
                        <?php
						//$conn->debug=true; 	
						$_SESSION['ingenid'] = $id;
