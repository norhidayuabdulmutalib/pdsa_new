...
<tr>
                               ...
                               <td width="12%"><?php print $rs->fields['cl_depcd'];?></td>
                               <td width="14%">PTJ</td>
                               <td width="12%"><?php print $rs->fields['cl_ptjcd'];?></td>
                               <td width="16%">No. Rujukan Dok. Asal</td>
                               <td width="18%"><?php print $rs->fields['cl_docno'];?></td>
                  <td width="16%">Jenis Dok. Asal</td>
</tr>
                           <tr>
                             <td colspan="2">Pejabat Perakaunan                             </td>
                             <td colspan="2"><?php print $rs->fields['cl_accoffcd'];?>&nbsp;</td>
                               <td>No. Gaji</td>
                               <td><?php print $rs->fields['cl_gajino'];?>&nbsp;</td>
                               <td><?php print $rs->fields['cl_doctype'];?></td>
                  </tr>
                           <tr>
                             <td colspan="2">Pusat Pembayaran</td>
                             <td colspan="2"><?php print $rs->fields['cl_payctrcd'];?></td>
                             <td>Bulan</td>
                           ...
                           <tr>
                             ...
                             <td colspan="2"><?php print $rs->fields['cl_brchcd'];?>&nbsp;</td>
                             <td>Tahun</td>
                             <td><?=$cl_year?>&nbsp;</td>
                             <td>&nbsp;</td>
                           </tr>
  ...
  <?=dlookup("_tbl_instructor", "insid", " ingenid = ".$_SESSION['ingenid'])?>                </td>
            ...
            <tr>
                ...
                <td width="93%" colspan="2">a)&nbsp;&nbsp;&nbsp;Gaji pokok : <?php print $rs->fields['cl_gaji'];?></td>
            </tr>
            ...
            <tr>
                ...
                <td width="93%" colspan="2">b)&nbsp;&nbsp;&nbsp;Elaun Memangku (Jika ada) : <?php print $rs->fields['cl_elaun'];?></td>
            </tr>
            ...
            <tr>
                ...
                <td width="93%" colspan="2">c)&nbsp;&nbsp;&nbsp;No. Gaji / Pekerja : <?php print $rs->fields['cl_gajino'];?></td>
            </tr>
            ...
            <tr>
                ...
                <?php print $rs->fields['cl_bank'];?>&nbsp;<?php print $rs->fields['cl_bankbrch'];?></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2">No. Akaun Bank : <?php print $rs->fields['cl_akaun'];?></td>
            </tr>
            <tr>
              <td height="40">&nbsp;&nbsp;&nbsp;9.</td>
              <td colspan="2">Nama Kementerian / Jabatan / Agensi :
<?php print $rs->fields['cl_orgdesc'];?></td>
            </tr>
            <tr>
              <td height="40" valign="top">&nbsp;&nbsp;&nbsp;10.</td>
              <td colspan="2">Alamat Kementerian / Jabatan / Agensi :
<?php print $rs->fields['cl_orgadd'];?></td>
            </tr>
    ...
    <td><table width="95%" cellpadding="3" cellspacing="0" border="0">
      ...
      <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
        ...
        <td valign="top" align="left"><?=dlookup("_tbl_kursus", "coursename", " id = ".$rs2->fields['cl_eve_course_id'])?>
          &nbsp;</td>
        <td valign="top" align="left"><?php echo DisplayDate($rs2->fields['cl_eve_startdate'])." - ".DisplayDate($rs2->fields['cl_eve_enddate']);?>&nbsp;</td>
        <td valign="top" align="left"><?=$rs2->fields['cl_eve_tempoh']?>
          &nbsp;</td>
        <td valign="top" align="center"><?php echo $pay; ?>&nbsp;</td>
        </tr>
      <?
...
<table width="95%" border="0" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
    <td height="40">&nbsp;&nbsp;&nbsp;3.</td>
    <td>Kod Jabatan</td>
    <td colspan="2">: <?php print $rs->fields['cl_depcd'];?></td>
  </tr>
  <tr>
    <td height="40">&nbsp;&nbsp;&nbsp;4.</td>
    <td>Kod dan Nama PTJ</td>
    <td colspan="2">: <?php print $rs->fields['cl_ptjcd'];?> / <?php print $rs->fields['cl_ptjdesc'];?></td>
  </tr>
  <tr>
    <td height="40">&nbsp;&nbsp;&nbsp;5.</td>
  ...
  <tr>
    ...
    <td width="77%" colspan="2">: <?php print $rs->fields['cl_gajino'];?></td>
  </tr>
  <tr>
    <td width="6%" height="40">&nbsp;&nbsp;7.</td>
    <td width="17%">Nama dan Kod Pusat Pembayar</td>
    <td width="77%" colspan="2">: <?php print $rs->fields['cl_payctrdesc'];?> / <?php print $rs->fields['cl_payctrcd'];?></td>
  </tr>
  <tr>
    <td width="6%" height="40">&nbsp;&nbsp;8.&nbsp;</td>
    <td width="17%">Cawangan dan Kod Cawangan</td>
    <td width="77%" colspan="2">: <?php print $rs->fields['cl_brchdesc'];?> / <?php print $rs->fields['cl_brchcd'];?></td>
  </tr>
  <tr>
    <td height="40">&nbsp;&nbsp;9.</td>
    <td>Alamat Bank</td>
    <td colspan="3">: <?php print $rs->fields['cl_bank'];?>&nbsp;<br />&nbsp;</td>
  </tr>
  <tr>
    <td height="40">&nbsp;10.</td>
    <td>No. Akaun</td>
    <td colspan="2">: <?php print $rs->fields['cl_akaun'];?></td>
  </tr>
  <tr>
