...
<title>Cetakan Buku Bank Penceramah</title>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="1">
    <tr>
    	<td width="100%" class="title" height="25">PAPARAN BUKU BANK PENCERAMAH</td>
    </tr>
    <tr><td width="100%">
    <img src="all_pic/img_bukubank.php?id=<?php echo $id;?>"><br />
    </td></tr>
</table>
</form>
