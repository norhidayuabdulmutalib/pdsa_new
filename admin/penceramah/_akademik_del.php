...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="1">
    <tr>
    	<td colspan="2" class="title" height="25">PADAM MAKLUMAT AKADEMIK PENCERAMAH</td>
    </tr>
	<tr><td colspan="2">
    	<table width="90%" cellpadding="5" cellspacing="1" border="0" align="center">
            ...
            <tr>
                <td colspan="3" align="center">
                    <input type="button" value="Ya" class="button_disp" title="Sila klik untuk padam maklumat" onClick="form_hantar('modal_form.php?<?php print $URLs;?>&pro=DEL')" >
...
<?php } else {
	...
	$id=$_REQUEST["id"];
	if(!empty($id)){
		$sql = "DELETE FROM _tbl_instructor_akademik WHERE ingenid_akademik=".tosql($id,"Text");
		$rs = &$conn->Execute($sql);
		audit_trail($sql,"");
	}
