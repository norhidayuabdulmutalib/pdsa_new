	...
	<tr><td colspan="2">
    	...
    	<table width="100%" cellpadding="1" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <?php if(empty($id)){ ?>onchange="do_search('index.php?data=<?php print base64_encode($userid.';apps/penceramah/penceramah_form.php;penceramah;daftar');?>')" <?php } ?>/> cth: 700104102478</td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" size="65" name="insname" value="<?php print $rs->fields['insname'];?>" /></td>
            ...
            <tr>
              ...
              <td width="80%" colspan="3"><input name="insorganization" type="text" id="insorganization" value="<?php print $rs->fields['insorganization'];?>" size="65" /></td>
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" name="inshometel" size="20" maxlength="15" value="<?php print $rs->fields['inshometel'];?>"></td>
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" name="insmobiletel" size="20" maxlength="15" value="<?php print $rs->fields['insmobiletel'];?>"></td>
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" name="insfaxno" size="20" maxlength="15" value="<?php print $rs->fields['insfaxno'];?>"></td>
            ...
            <tr>
                ...
                <td width="50%" colspan="2"><input type="text" name="insemail" size="50" value="<?php print $rs->fields['insemail'];?>"></td>
            ...
            <tr>
                ...
                <td colspan="2"><textarea cols="60" rows="4" name="insaddress"><?php print $rs->fields['insaddress'];?></textarea></td>
          ...
          <tr>
            ...
            <tr>
 			...
 			<tr>
                ...
                <td width="20%">Kadar bayaran sejam : </td>

                <td width="80%" colspan="3">RM<input type="text" name="payperhours" value="<?php print $rs->fields['payperhours'];?>" />(Masukkan angka sahaja!)</td>
            ...
            <tr>
                ...
                <td width="80%" colspan="3"><input type="text" name="insbank"  size="65" value="<?php print $rs->fields['insbank'];?>" /></td>

            </tr>

            <tr>

                <td width="20%">Cawangan Bank : </td>

                <td width="80%" colspan="3"><input type="text" name="insbankbrch"  size="65" value="<?php print $rs->fields['insbankbrch'];?>" /></td>

            </tr>

            <tr>

                <td width="20%">No. Akaun Bank : </td>

                <td width="80%" colspan="3"><input type="text" name="insakaun"  size="65" value="<?php print $rs->fields['insakaun'];?>" /></td>
            ...
            <?php if(empty($id)) { ?> onclick="alert('Sila tekan SIMPAN dahulu sebelum menambah maklumat akademik!')" <?php } else { ?> onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Akademik',700,400)" <?php } ?> /> &nbsp;&nbsp;</td>
                ...
                <table width="100%" cellpadding="1" cellspacing="0" border="1">
                        ...
                        <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                            ...
                            <td valign="top" align="left"><?=$rs2->fields['inaka_tahun']?>&nbsp;</td>

                            <td align="center">

                            	<img src="../img/icon-info1.gif" width="30" height="30" style="cursor:pointer" title="Sila klik untuk pengemaskinian data" 

                                onclick="open_modal('<?=$href_link;?>','Kemaskini Maklumat Akademik',700,400)" />

                            	<img src="../img/ico-cancel.gif" width="30" height="30" style="cursor:pointer" title="Sila klik untuk penghapusan data" onclick="open_modal('<?=$del_href_link;?>','Padam Maklumat Akademik',700,300)" />
            ...
            <?php if(empty($id)) { ?> onclick="alert('Sila tekan SIMPAN dahulu sebelum menambah bidang kepakaran!')" <?php } else { ?> onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Kepakaran',700,400)" <?php } ?> /> &nbsp;&nbsp;</td>
            ...
            <tr>
                ...
                <td><br>
                    ...
                    onClick="form_hantar('index.php?data=<?php print base64_encode($userid.';apps/penceramah/penceramah_form_do.php;penceramah;daftar')?>')">

                	<?php if(!empty($id)){ 
					
					$_SESSION['ingenid'] = $id;
					
					$claim_link = "index.php?data=".base64_encode($userid.';apps/penceramah/claim_list.php;penceramah;daftar;'.$rs->fields['ingenid']);
					
					?>
                    
                    <input type="button" value="Hapus" class="button_disp" title="Sila klik untuk hapus maklumat penceramah" 

                    onClick="form_hapus('index.php?data=<?php print base64_encode($userid.';apps/penceramah/penceramah_form_do.php;penceramah;daftar')?>')">
                    
                    <input type="button" value="Claim" class="button_disp" title="Sila klik untuk edit maklumat claim penceramah" 

                    onClick="document.location='<?php print $claim_link; ?>'">

                    <?php } ?>

                	<input type="button" value="Kembali" class="button_disp" title="Sila klik untuk ke senarai penceramah" 

                    onClick="do_back('index.php?data=<?php print base64_encode($userid.';apps/penceramah/penceramah_list.php;penceramah;daftar');?>')">
