	...
	<tr><td colspan="2">
    	<table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
            ...
            <tr>
                ...
                <td width="50%" colspan="2">
				<select name="inskategori">
                        <?php 
                           $r_kategori = dlookupList('_ref_kategori_penceramah', 'f_kp_id, f_kp_kenyataan', '', 'f_kp_sort ASC');
                           while ($row_kategori = mysql_fetch_array($r_kategori, MYSQL_BOTH)) { ?>
                           <option value="<?=$row_kategori['f_kp_id'] ?>" <?php if($rs->fields['inskategori'] == $row_kategori['f_kp_id']) echo "selected"; ?> ><?=$row_kategori['f_kp_kenyataan']?></option>
                        <?php }?>        
                   </select>   
                </td>
            </tr>
          ...
          <tr>
			...
			<tr>
                ...
                <td rowspan="4" align="center"><?php if(!empty($id)){ 
					$href_imgbb = "modal_form.php?win=".base64_encode('penceramah/penceramah_view_bbank.php;'.$rs->fields['ingenid']); ?>
                    <img src="all_pic/img_bukubank.php?id=<?php echo $rs->fields['ingenid'];?>" width="100" height="100" border="0"
                      onclick="open_modal('<?=$href_imgbb;?>','Paparan & Cetakan Buku Bank',800,450)" style="cursor:pointer">
                    <br>
            ...
            <tr>
                <td><b>Nama Bank : </b></td>
                <td colspan="3"><input type="text" name="insbank"  size="65" value="<?php print $rs->fields['insbank'];?>" /></td>
            </tr>
            <tr>
                <td><b>Cawangan Bank : </b></td>
                <td colspan="2"><input type="text" name="insbankbrch"  size="65" value="<?php print $rs->fields['insbankbrch'];?>" /></td>
            </tr>
            <tr>
                <td><b>No. Akaun Bank : </b></td>
                <td colspan="2"><input type="text" name="insakaun"  size="65" value="<?php print $rs->fields['insakaun'];?>" /></td>
            </tr>
            <tr>
