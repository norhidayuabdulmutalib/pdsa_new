...
<!-- <table width="98%" align="center" cellpadding="1" cellspacing="0" border="0">
	...
	<tr><td colspan="2"> -->
                  <table width="100%" cellpadding="3" cellspacing="0" border="0" align="center">
                    <tr>
                      <td colspan="3" class="title" height="30"><strong>BAHAGIAN 1 : BUTIR-BUTIR PERIBADI</strong></td>
                    </tr>
                    <?php
            ...
            <tr>
                ...
                <input type="text" size="65" name="cl_name" value="<?php print $rs_inst->fields['insname'];?>" />
            ...
            <tr>
                ...
                <td width="80%" colspan="2"><input name="cl_gaji" type="text" id="cl_gaji" value="<?php print $rs->fields['cl_gaji'];?>" size="20" maxlength="15"></td>
            </tr>
            <tr>
                <td width="30%">Elaun Memangku (Jika ada) : </td>
                <td width="80%" colspan="2"><input name="cl_elaun" type="text" id="cl_elaun" value="<?php print $rs->fields['cl_elaun'];?>" size="20" maxlength="15"></td>
            </tr>
            <tr>
                <td width="30%">No. Gaji / Pekerja : </td>
                <td width="80%" colspan="2"><input name="cl_gajino" type="text" id="cl_gajino" value="<?php print $rs->fields['cl_gajino'];?>" size="20" maxlength="15"></td>
            </tr>
            <tr>
                <td width="30%">Kadar Bayaran Sejam : </td>
                <td width="80%" colspan="2"><input name="payperhours" type="text" id="cl_gajino" value="<?php print $rs_inst->fields['payperhours'];?>" size="20" maxlength="15"></td>
            </tr>
            <tr>
                <td>Nama Bank : </td>
                <td colspan="3"><input type="text" name="cl_bank"  size="65" value="<?php print $rs->fields['cl_bank'];?>" />
            ...
            <tr>
                <td>Cawangan Bank : </td>
                <td colspan="2"><input type="text" name="cl_bankbrch"  size="65" value="<?php print $rs->fields['cl_bankbrch'];?>" /></td>
            </tr>
            <tr>
                <td>No. Akaun Bank : </td>
                <td colspan="2"><input type="text" name="cl_akaun"  size="65" value="<?php print $rs->fields['cl_akaun'];?>" /></td>
            </tr>
            <tr>
              <td>Nama Kementerian / Jabatan / Agensi : </td>
              <td colspan="2"><input name="cl_orgdesc" type="text" id="cl_orgdesc" value="<?php print $rs->fields['cl_orgdesc'];?>" size="80" /></td>
            </tr>
            <tr>
              <td valign="top">Alamat Kementerian / Jabatan / Agensi : </td>
              <td colspan="2"><textarea cols="80" rows="4" name="cl_orgadd" id="cl_orgadd"><?php print $rs->fields['cl_orgadd'];?></textarea></td>
            </tr>
            <tr>
                <td colspan="3" class="title" height="30"><strong>KEMENTERIAN / JABATAN / AGENSI PENGANJUR</strong></td>
           </tr>
            <tr>
                <td colspan="3"><table width="99%" cellpadding="3" cellspacing="0" border="1" align="center">
<tr>
                  <td width="14%">Kod Jabatan</td>
                  <td width="48%"><input type="text" name="cl_depcd" size="20" maxlength="15" value="<?php print $rs->fields['cl_depcd'];?>" /></td>
                  <td width="16%">Kod Pejabat Perakaunan</td>
                  <td width="22%"><input name="cl_accoffcd" type="text" id="cl_accoffcd" value="<?php print $rs->fields['cl_accoffcd'];?>" size="20" maxlength="15" /></td>
                  </tr>
                  <tr>
                               <td>PTJ</td>
                               <td><input type="text" name="cl_ptjdesc"  size="60" value="<?php print $rs->fields['cl_ptjdesc'];?>" /></td>
                             <td>Kod PTJ</td>
                               <td><input type="text" name="cl_ptjcd" size="20" maxlength="15" value="<?php print $rs->fields['cl_ptjcd'];?>" /></td>
                  </tr>
                           <tr>
                             <td>Pusat Pembayaran</td>
                             <td><input type="text" name="cl_payctrdesc"  size="60" value="<?php print $rs->fields['cl_payctrdesc'];?>" /></td>
                             <td>Kod Pusat Pembayaran</td>
                             <td><input type="text" name="cl_payctrcd" size="20" maxlength="15" value="<?php print $rs->fields['cl_payctrcd'];?>" /></td>
                           </tr>
                           <tr>
                             <td>Cawangan</td>
                             <td><input type="text" name="cl_brchdesc"  size="60" value="<?php print $rs->fields['cl_brchdesc'];?>" /></td>
                             <td>Kod Cawangan</td>
                             <td><input type="text" name="cl_brchcd" size="20" maxlength="15" value="<?php print $rs->fields['cl_brchcd'];?>" /></td>
                           </tr>
                           <tr>
                             <td>Jenis Dok. Asal</td>
                             <td><input type="text" name="cl_doctype"  size="60" value="<?php print $rs->fields['cl_doctype'];?>" /></td>
                             <td>No. Rujukan Dok. Asal</td>
                             <td><input type="text" name="cl_docno" size="20" maxlength="15" value="<?php print $rs->fields['cl_docno'];?>" /></td>
                           </tr>
                           <tr>
                             <td>Bulan</td>
            ...
            <tr>
                <td colspan="3" class="title" height="30"><br /><br /><strong>BUTIR - BUTIR PERMOHONAN</strong></td>
          </tr>
            <tr>
                <td colspan="3">
