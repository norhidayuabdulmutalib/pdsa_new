...
//('Unknown position for values on bars :'.$this->valuepos);
		...
		//update by nizam
		//$this->csimareas .= " href=\"".htmlentities($this->csimtargets[$i])."\" target=_blank";
		$this->csimareas .= " href=# onclick=\"open_windows('".htmlentities($this->csimtargets[$i])."','Paparan Statistik',850,510)\"";
