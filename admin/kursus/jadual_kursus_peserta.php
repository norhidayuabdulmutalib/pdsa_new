        ...
        <table width="96%" cellpadding="4" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <?php if($btn_display==1){ ?>
                	...
                	<i>Klik <input type="button" value="Proses Surat" style="cursor:pointer" 
        ...
        <table width="96%" cellpadding="4" cellspacing="0" border="1" align="center">
            <tr bgcolor="#CCCCCC">
                ...
                <?php //if($btn_display==1){ ?>
                    ...
                    <?php //if($end_date>$curr_date){ ?>
                    <input type="button" value="Pilih Peserta (On-Line)" style="cursor:pointer;background-color:#996;font-weight:bold"
                    ...
                    <input type="button" value="Pilih Peserta" style="cursor:pointer;background-color:#996;font-weight:bold"
                    ...
                    <input type="button" value="Tambah Peserta Baru" style="cursor:pointer;background-color:#996;font-weight:bold"
