...
<table width="80%" cellpadding="5" cellspacing="1" border="0" align="center">
	...
	<?php } ?>
<?php 
$loksi = $rss->fields['ref_ts_position']; 
if(empty($loksi)){ $loksi='center'; } 
//$loksi='right';
?>
     <tr>
        <td align="<?php print $loksi;?>" height="150px"><br /><br /><br />
        <div align="center" style="width:400px">
        <b>(<?=$oleh;?>)</b><br /><?=$jawatan;?>
        <br /><!--Institut Latihan Islam Malaysia-->
        <?php print dlookup("_ref_kampus","kampus_nama","kampus_id=".tosql($rss->fields['kampus_id'])); ?>
