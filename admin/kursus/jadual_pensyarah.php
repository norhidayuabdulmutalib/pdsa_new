...
<table width="90%" cellpadding="4" cellspacing="0" border="1" align="center">
    ...
    <tr>
        ...
        <td align="center">
            <img src="../img/edit.png" border="0" style="cursor:pointer" onclick="open_modal1('<?php print $href_link_add;?>&id_masa=<?=$idh;?>','Penambahan Maklumat Jadual',90,90)" />
        	<?php if($btn_display==1){ ?>
			<img src="../img/delete_btn1.jpg" border="0" style="cursor:pointer" width="20" height="25" onclick="do_hapus('jadual_kursus_maklumat','<?=$idh;?>')" />
            <?php } ?>
        </td>
    </tr>
    <?php $rs_det->movenext(); } ?>
