            ...
            <tr>
                ...
                <td width="50%" colspan="2">
                	<select name="f_kg_status">
                    	<option value="0" <?php if($rs->fields['f_kg_status']=='0'){ print 'selected'; }?>>Aktif</option>
                    	<option value="1" <?php if($rs->fields['f_kg_status']=='1'){ print 'selected'; }?>>Tidak Aktif</option>
                    </select>
                </td>
            </tr>
