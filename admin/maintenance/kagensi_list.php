...
$href_search = "index.php?data=".base64_encode($userid.';maintenance/kagensi_list.php;admin;kagensi');
?>
					...
					<div class="card-body">
                        <table width="100%" cellpadding="3" cellspacing="0" border="0">
                            <tr class="title" >
                                ...
                                <?php $new_page = "modal_form.php?win=".base64_encode('maintenance/kagensi_form.php;');?>
                                    <button class="btn btn-success" value="Tambah Maklumat Agensi Tempat Bertugas" style="cursor:pointer" 
                                    onclick="open_modal('<?=$new_page;?>','Penambahan Maklumat Agensi Tempat Bertugas',700,400)" />&nbsp;&nbsp;
                                    <i class="fas fa-plus"></i> Tambah Maklumat Agensi Tempat Bertugas</button> 
                                </td>
                            </tr>
                            ...
                            <div class="table-responsive">
								<table class="table table-bordered" id="table_kursusMohonList" name="table_kursusMohonList">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%" align="center"><b>KOD Agensi</b></th>
                                        <th width="40%" align="center"><b>Agensi Bertugas</b></th>
                                        ...
                                        if(!$rs->EOF) {
                                            ...
                                            while(!$rs->EOF  && $cnt <= $pg) {
                                                ...
                                                <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                                                    ...
                                                    <td valign="top" align="left"><?php echo stripslashes($rs->fields['ref_kt_kod']);?>&nbsp;</td>
                                                    <td valign="top" align="left"><?php echo stripslashes($rs->fields['ref_kt_nama']);?>&nbsp;</td>
                                                    <td valign="top" align="center">
                                                        <?php if($rs->fields['ref_kt_status']=='0'){ print 'Aktif'; }
