...
$href_search = "index.php?data=".base64_encode($userid.';maintenance/logmasuk_list.php;admin;logmasuk');
?>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
					<div class="card-header">
						<h4>Senarai Maklumat Log Masuk Pengguna</h4>
					</div>
					<div class="card-body">
                        ...
                        <div class="table-responsive">
								<table class="table table-bordered" id="table_kursusMohonList" name="table_kursusMohonList">
                                    ...
                                    <tr>
                                        ...
                                        <th width="45%" align="center"><b>Maklumat Proses</b></th>
                                        <th width="20%" align="center"><b>Pengguna</b></th>
                                    ...
                                    if(!$rs->EOF) {
                                        ...
                                        while(!$rs->EOF  && $cnt <= $pg) {
                                            ...
                                            <tr bgcolor="<?php if ($cnt%2 == 1) echo $bg1; else echo $bg2 ?>">
                                                ...
                                                <td valign="top" align="center"><?php echo stripslashes($rs->fields['log_user']);?>&nbsp;</td>
                                                <td valign="top" align="center"><?php echo stripslashes($rs->fields['trans_date']);?>&nbsp;</td>
