...
//print $tahun;
$width="100%";
//$sqly = "SELECT DISTINCT year(startdate) AS yr FROM _tbl_kursus_jadual WHERE year(startdate)>=2008 ORDER BY year(startdate) DESC ";
//$rsyear = &$conn->execute($sqly);
//if(empty($tahun)){ $tahun=$rsyear->fields['yr']; }
$curmth = date("m");
$curyr = date("Y");
?>
