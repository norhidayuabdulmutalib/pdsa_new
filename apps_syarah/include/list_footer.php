  ...
  <tr>
    <td class="corporatedesc">
        ...
        for($c=$CounterStart;$c<=$CounterEnd;$c++){
            if($c < $MaxPage){
                if($c == $PageNo){
					...
					echo "<a href=\"#\" onclick=\"get_page('$sFileName&page=$c')\">$c</a> ";
      ...
      if($CounterEnd < $MaxPage){
		  ...
		  echo "<a href=\"#\" onclick=\"get_page('$sFileName&page=$NextPage')\">Laman Seterusnya</a>";
      ...
      if($CounterEnd < $MaxPage){
       $LastRec = $RecordCount % $PageSize;
        ...
        print " : ";
		echo "<a href=\"#\" onclick=\"get_page('$sFileName&page=$MaxPage')\">Laman Terakhir</a>";
        //echo "<a href=$sFileName&page=$MaxPage>Laman Terakhir</a>";
        }
      ?><br> 
	  <?php //echo "<b>Jumlah Rekod : $RecordCount - M/S $PageNo Daripada $MaxPage</b>";  ?>
	  <?php echo "Halaman: <b>$PageNo</b> daripada: <b>$MaxPage</b>";  ?>
      </div>
    </td>
  </tr>
</table>
