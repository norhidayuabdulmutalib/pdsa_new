...
<ul class="menu5">
    ...
    <li <? if($menu=='peserta'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/dmasuk_list.php;peserta;peserta');?>"><b>Biodata Pensyarah</b></a></li>
    <li <? if($menu=='kursusluar'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/dmasuk_list_kursusluar.php;kursusluar;kursusluar');?>"><b>Maklumat Jadual Kursus</b></a></li>
  	<li <? if($menu=='penghuni'){ print 'class="current"'; }?>>
    	<a href="index.php?data=<? print base64_encode('user;asrama/penghuni_list.php;penghuni;penghuni');?>"><b>Laporan Penilaian</b></a></li>
